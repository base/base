...
Due to a consensus layer bug, rollup chains on Holesky and Sepolia running officially released op-node software
...
These chains, or any rollup chain with a sequencer running
