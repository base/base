...
Base Chain inherits Ethereum's EVM semantics, transaction rules, and L1-anchored security. After
the Jovian Hardfork, Base Chain follows this specification as the source of truth.
