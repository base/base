...
Experiences from running Base chains for over one and a half years have shown that these relaxed
...
experienced this on OP Mainnet or other mainnet Base chains yet.
