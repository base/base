//! `SystemTestUrls` type for managing RPC endpoints.

use std::{fmt, path::Path};

use eyre::{Result, WrapErr};

/// RPC URLs for a system test stack.
#[derive(Debug, Clone, serde::Deserialize, serde::Serialize)]
pub struct SystemTestUrls {
    /// L1 RPC endpoint
    pub l1_rpc: String,
...
impl fmt::Display for SystemTestUrls {
...
impl SystemTestUrls {
    /// Read `SystemTestUrls` from a JSON file.
    ...
    /// Write `SystemTestUrls` to a JSON file.
