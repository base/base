...
# Configuration
# ---------------------------------------------------------------------------
OP_NODE_URL="${OP_NODE_URL:-https://base-mainnet-geth-mempool-k8s-donotuse.cbhq.net:7545}"
L1_ETH_URL="${L1_ETH_URL:-https://convincing-omniscient-market.quiknode.pro/ac0c760ac33085736044bee6ef3f77ba9fe2139a/}"
