...
mod ssz_requests_conversions {
    use alloy_eips::{
        eip6110::{DEPOSIT_REQUEST_TYPE, DepositRequest, MAX_DEPOSIT_RECEIPTS_PER_PAYLOAD},
        eip7002::{MAX_WITHDRAWAL_REQUESTS_PER_BLOCK, WITHDRAWAL_REQUEST_TYPE, WithdrawalRequest},
        eip7251::{
            CONSOLIDATION_REQUEST_TYPE, ConsolidationRequest, MAX_CONSOLIDATION_REQUESTS_PER_BLOCK,
        },
        eip7685::Requests,
    };
