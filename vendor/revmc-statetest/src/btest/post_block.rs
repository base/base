use revm_context::{Block, ContextTr, JournalTr};
...
use revm_statetest_types_42_0_0::blockchain::Withdrawal;

/// Post block transition that includes:
///   * Block and uncle rewards before the Merge/Paris hardfork.
///   * Withdrawals (EIP-4895)
///   * Post-block system calls: EIP-7002 (withdrawal requests) and EIP-7251 (consolidation
///     requests)
///
/// # Note
///
