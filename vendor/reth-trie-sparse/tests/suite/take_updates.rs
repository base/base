...
pub(super) fn test_take_updates_resets_after_take(new_trie: fn() -> ArenaParallelSparseTrie) {
...
pub(super) fn test_take_updates_cross_cancellation_across_root_calls(
    new_trie: fn() -> ArenaParallelSparseTrie,
) {
...
pub(super) fn test_take_updates_no_duplicate_updated_and_removed_nodes(
    new_trie: fn() -> ArenaParallelSparseTrie,
) {
