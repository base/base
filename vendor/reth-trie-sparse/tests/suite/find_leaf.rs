...
pub(super) fn test_find_leaf_exists(new_trie: fn() -> ArenaParallelSparseTrie) {
    ...
    let trie: ArenaParallelSparseTrie = harness.init_trie_fully_revealed(false, new_trie);
...
pub(super) fn test_find_leaf_nonexistent(new_trie: fn() -> ArenaParallelSparseTrie) {
    let key1 = B256::with_last_byte(0x10);
    let key2 = B256::with_last_byte(0x20);
    let key3 = B256::with_last_byte(0x30);
...
pub(super) fn test_find_leaf_blinded(new_trie: fn() -> ArenaParallelSparseTrie) {
    ...
    let trie: ArenaParallelSparseTrie =
...
pub(super) fn test_find_leaf_value_mismatch(new_trie: fn() -> ArenaParallelSparseTrie) {
    let key1 = B256::with_last_byte(0x10);
    let key2 = B256::with_last_byte(0x20);
    let key3 = B256::with_last_byte(0x30);
...
pub(super) fn test_find_leaf_nonexistent_branch_divergence(
...
pub(super) fn test_find_leaf_nonexistent_extension_divergence(
    new_trie: fn() -> ArenaParallelSparseTrie,
) {
...
pub(super) fn test_find_leaf_nonexistent_leaf_divergence(
    new_trie: fn() -> ArenaParallelSparseTrie,
) {
