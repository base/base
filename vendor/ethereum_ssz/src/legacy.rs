...
mod test {
    ...
    fn two_variable_len_options_encoding() {
        let s = TwoVariableLenOptions { a: 42, b: None, c: Some(vec![0]), d: None };
    ...
    fn two_variable_len_options_round_trip() {
        let vec: Vec<TwoVariableLenOptions> = vec![
            TwoVariableLenOptions { a: 42, b: Some(12), c: Some(vec![0]), d: Some(vec![1]) },
            TwoVariableLenOptions { a: 42, b: Some(12), c: Some(vec![0]), d: None },
            TwoVariableLenOptions { a: 42, b: None, c: Some(vec![0]), d: None },
            TwoVariableLenOptions { a: 42, b: None, c: None, d: None },
        ];
