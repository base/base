...
mod test {
    ...
    fn test_invalid_uints() {
        ...
        assert_eq!(U256::decode(&mut &hex!("820000")[..]), Err(Error::LeadingZero));
        ...
        // 0x7f, 0x33
        assert_eq!(U256::decode(&mut &hex!("8100")[..]), Err(Error::NonCanonicalSingleByte));
        assert_eq!(U256::decode(&mut &hex!("817f")[..]), Err(Error::NonCanonicalSingleByte));
        assert_eq!(U256::decode(&mut &hex!("8133")[..]), Err(Error::NonCanonicalSingleByte));
    }
}
