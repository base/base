...
use postgres_types_0_2::{FromSql, IsNull, ToSql, Type, WrongType, to_sql_checked};
use thiserror::Error;
...
mod tests {
    ...
    fn test_basic() {
        ...
        assert_eq!(
            bytes(Type::NUMERIC),
            hex!(
                "0014001300000000000902760e3620f115a21c3b029709bc11e60b3e10d10d6900d123400def1c45091a147900f012f4"
            )
        );
        assert_eq!(
            bytes(Type::BYTEA),
        ...
        assert_eq!(
            bytes(Type::CHAR),
            hex!(
                "307863383565663764373936393166653739353733623161373036346331396331613938313965626462643166616161623161386563393233343434333861616634"
            )
        );
        assert_eq!(
            bytes(Type::TEXT),
