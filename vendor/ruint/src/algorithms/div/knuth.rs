...
pub unsafe fn div_nxm(numerator: &mut [u64], divisor: &mut [u64]) {
    ...
    let (d, shift) = {
        ...
        (
            if shift == 0 { d } else { (d << shift) | u128::from(divisor[n - 3] >> (64 - shift)) },
            shift,
        )
    };
...
mod tests {
    ...
    fn test_divrem_8by4() {
        ...
        let divisor =
            [0x800000000000000, 0x580c0c40583c55b5, 0x6b16b3fb5bd85ed3, 0xcc958c207ce3c96f];
        ...
        let expected_remainder =
            [0x9800000000000000, 0x70efd2d3f528c8d9, 0x6dad759fcd6af14a, 0x5fe38801c609f277];
    ...
    fn test_div_rollback() {
        let mut numerator =
            [0x1656178c14142000, 0x821415dfe9e81612, 0x1616561616161616, 0x96000016820016];
    ...
    fn test_div_rollback_2() {
        ...
        let expected_remainder =
            [0xdb6db6dc6ea00000, 0x80ffe, 0xf2492492492ec00, 0x1000, 0x2000000000000000];
        unsafe { div_nxm_normalized(&mut numerator, &divisor) };
        let (remainder, quotient) = numerator.split_at(divisor.len());
        assert_eq!(quotient, expected_quotient);
        assert_eq!(remainder, expected_remainder);
    ...
    fn test_div_nxm_8by4_noshift() {
        ...
        let mut divisor =
            [0x800000000000000, 0x580c0c40583c55b5, 0x6b16b3fb5bd85ed3, 0xcc958c207ce3c96f];
        let quotient =
            [0x9128464e61d6b5b3, 0xd9eea4fc30c5ac6c, 0x944a2d832d5a6a08, 0x22f06722e8d883b1];
        let remainder =
            [0x9800000000000000, 0x70efd2d3f528c8d9, 0x6dad759fcd6af14a, 0x5fe38801c609f277];
    ...
    fn test_div_nxm_8by4_shift() {
        ...
        let mut divisor = [0xc91e935375a97723, 0x86a9ded3044ec12b, 0xc7d2c4d3b53bff51, 0x6ef0530d];
        let quotient =
            [0x456b1581ef1a759a, 0x88702c90bbe2ef3c, 0xff8492ee85dec642, 0x8ca39da4ca785f36];
        let remainder = [0x82c3522848567314, 0xeaba6edb18db568e, 0x18f16cfde22dcefe, 0x11296685];
        unsafe { div_nxm(&mut numerator, &mut divisor) };
        assert_eq!(&numerator[..quotient.len()], quotient);
        assert_eq!(divisor, remainder);
    }
    ...
    fn test_div_nxm_8by4_q_high() {
        ...
        let mut divisor = [0x439702d44a8f62a4, 0x8dfa6ea7fc41f689, 0xc79723ff4dd060e0, 0x7d13e204];
        let quotient = [0x181cecbb64efa48b, 0x1e97056793a15125, 0xe8145d63cd312d02, 0xc5a9aced];
        let remainder = [0x682e10f8d0b1b3c0, 0xbf46c8b0e5ac8a62, 0x5abe292d53acf085, 0x699fc911];
        unsafe { div_nxm(&mut numerator, &mut divisor) };
        assert_eq!(&numerator[..quotient.len()], quotient);
        assert_eq!(divisor, remainder);
    }
    ...
    fn test_div_nxm_4by4() {
        let mut numerator =
            [0x55a8f128f187ecee, 0xe059a1f3fe52e559, 0x570ab3b2aac5c5d9, 0xf7ea0c73b80ddca1];
        let mut divisor =
            [0x6c8cd670adcae7da, 0x458d6428c7fd36d3, 0x4a73ad64cc703a1d, 0x33bf790f92ed51fe];
        let quotient = [0x4];
        let remainder =
            [0xa37597663a5c4d86, 0xca241150de5e0a0b, 0x2d3bfe1f7904dd64, 0x28ec28356c5894a8];
        unsafe { div_nxm(&mut numerator, &mut divisor) };
        assert_eq!(&numerator[..quotient.len()], quotient);
        assert_eq!(divisor, remainder);
    }
    ...
    fn test_div_nxm_4by3() {
        let mut numerator =
            [0x8000000000000000, 0x8000000000000000, 0x8000000000000000, 0x8000000000000001];
