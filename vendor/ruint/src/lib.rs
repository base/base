...
#![cfg_attr(feature = "nightly", feature(core_intrinsics, const_unsigned_bigint_helpers))]
#![cfg_attr(feature = "nightly", allow(internal_features, clippy::incompatible_msrv))]
#![cfg_attr(
...
impl<const BITS: usize, const LIMBS: usize> Uint<BITS, LIMBS> {
    ...
    pub const LIMBS: usize = {
        ...
        assert!(LIMBS == limbs, "Can not construct Uint<BITS, LIMBS> with incorrect LIMBS");
        limbs
    };
    ...
    pub const fn from_limbs(limbs: [u64; LIMBS]) -> Self {
        if Self::SHOULD_MASK {
            ...
            assert!(limbs[LIMBS - 1] <= Self::MASK, "Value too large for this Uint");
        }
...
mod test {
    ...
    fn test_max() {
        ...
        assert_eq!(Uint::<100, 2>::MAX, Uint::from_limbs([u64::MAX, u64::MAX >> 28]));
    }
