...
use alloy_transport::{Authorization, TransportErrorKind, TransportResult, utils::Spawnable};
use futures::{SinkExt, StreamExt};
use serde_json::value::RawValue;
use tokio::time::sleep;
use tokio_tungstenite_0_29_0::{
    MaybeTlsStream, WebSocketStream,
    tungstenite::{self, Message, client::IntoClientRequest},
};

use crate::{DEFAULT_KEEPALIVE, WsBackend};

type TungsteniteStream = WebSocketStream<MaybeTlsStream<tokio::net::TcpStream>>;

pub use tokio_tungstenite_0_29_0::tungstenite::protocol::WebSocketConfig;
...
impl PubSubConnect for WsConnect {
    ...
    async fn connect(&self) -> TransportResult<alloy_pubsub::ConnectionHandle> {
        ...
        let (socket, _) =
            tokio_tungstenite_0_29_0::connect_async_with_config(req, self.config, false)
                .await
