...
use alloy_primitives::{Address, B256, B512, hex, keccak256};
use alloy_signer::Signer;
use k256::ecdsa::{
    RecoveryId, Signature as K256Signature,
    signature::{Error as SignatureError, hazmat::PrehashSigner},
};
use rand_08::{CryptoRng, Rng};
use secp256k1::{Message, PublicKey, SECP256K1, Secp256k1, SecretKey};
...
mod tests {
    ...
    fn signs_msg() {
        ...
        let key = Secp256k1Signer::random_with(&mut rand_08::thread_rng());
