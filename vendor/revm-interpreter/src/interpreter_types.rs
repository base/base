...
use revm_primitives::{Address, B256, Bytes, U256, hardfork::SpecId};

use crate::{CallInput, InstructionResult, InterpreterAction, instructions::utility::IntoAddress};
...
///
/// Used in [`revm_bytecode::opcode::CODECOPY`] and [`revm_bytecode::opcode::CODESIZE`] opcodes.
