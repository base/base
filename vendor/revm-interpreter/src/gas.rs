...
pub use revm_context_interface::cfg::gas::*;
...
mod tests {
    ...
    fn test_refill_reservoir() {
        ...
        assert_eq!((gas.reservoir(), gas.remaining(), gas.state_gas_spent()), (500, 1000, 0));
        ...
        assert_eq!((gas.reservoir(), gas.remaining(), gas.state_gas_spent()), (400, 1000, -300));
    }
