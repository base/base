...
///
/// ```no_run
/// # async fn example<N: base_common_network::Network>(provider: impl alloy_provider::Provider, tx: base_common_types_rpc::transaction::TransactionRequest) -> Result<(), Box<dyn std::error::Error>> {
