...
use crate::{
    ...
    ere::types::{
        execution::{
            ...
            COMPRESSED_SLIM_RECEIPTS, CompressedBody, CompressedHeader, CompressedSlimReceipts,
            MAX_BLOCKS_PER_ERE, PROOF, Proof, TOTAL_DIFFICULTY, TotalDifficulty,
        },
        group::{DYNAMIC_BLOCK_INDEX, DynamicBlockIndex, EreGroup, EreId},
    },
};
