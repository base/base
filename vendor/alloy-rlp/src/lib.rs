...
mod decode;
pub use decode::{Decodable, Rlp, decode_append, decode_exact};
...
pub use encode::{
    Encodable, MaxEncodedLen, MaxEncodedLenAssoc, encode, encode_iter, encode_list,
    length_of_length, list_length,
};
