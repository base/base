...
use alloy_eips::{
    BlockNumHash, calc_next_block_base_fee,
...
use alloy_primitives::{Address, B64, B256, Bloom, Bytes, Sealable, Sealed, U256, keccak256};
...
impl ExecutionData {
    ...
    /// Conversion from [`base_common_consensus::Block`]. Also returns the [`ExecutionPayloadSidecar`]
    ...
    pub fn try_into_block<T: Decodable2718>(
        self,
    ) -> Result<base_common_consensus::Block<T>, PayloadError> {
        self.try_into_block_with(|tx| {
            T::decode_2718_exact(tx.as_ref())
                .map_err(alloy_rlp::Error::from)
                .map_err(PayloadError::from)
        ...
        let input = r#"
{
    ...
    fn roundtrip_payload_to_block() {
        let first_transaction_raw = Bytes::from_static(
            &hex!(
                ""
            )[..],
        );
        let second_transaction_raw = Bytes::from_static(
            &hex!(
                ""
            )[..],
        );
    ...
    fn test_v1_with_transactions_root_override() {
        let transaction = Bytes::from_static(&hex!(
            "f86d0a8458b20efd825208946177843db3138ae69679a54b95cf345ed759450d8806f3e8d87878800080820a95a0f8bddb1dcc4558b532ff747760a6f547dd275afdbe7bdecc90680e71de105757a014f34ba38c180913c0543b0ac2eccfb77cc3f801a535008dc50e533fbe435f53"
        ));
    ...
    fn serde_v3_with_many_transactions() {
        let tx = Bytes::from_static(&hex!(
            "f865808506fc23ac00830124f8940000000000000000000000000000000000000316018032a044b25a8b9b247d01586b3d59c71728ff49c9b84928d9e7fa3377ead3b5570b5da03ceac696601ff7ee6f5fe8864e2998db9babdf5eeba1a0cd5b4d44b3fcbd181b"
        ));
