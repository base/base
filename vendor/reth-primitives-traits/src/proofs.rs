...
#[doc(inline)]
pub use base_common_types_chain::proofs::calculate_ommers_root;
pub use base_common_types_chain::proofs::calculate_receipt_root;
/// Calculate a transaction root.
///
/// `(rlp(index), encoded(tx))` pairs.
#[doc(inline)]
pub use base_common_types_chain::proofs::calculate_transaction_root;
/// Calculates the root hash of the withdrawals.
#[doc(inline)]
pub use base_common_types_chain::proofs::calculate_withdrawals_root;
