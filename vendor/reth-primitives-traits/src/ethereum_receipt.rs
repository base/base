use alloy_consensus::{EthereumReceipt, TxTy};
...
#[derive(Debug)]
pub struct EthereumReceiptRoot;

impl EthereumReceiptRoot {
...
mod tests {
    ...
    fn test_decode_receipt() {
        reth_codecs::test_utils::test_decode::<EthereumReceipt<TxType>>(&hex!(
    ...
    fn gigantic_receipt() {
        ...
        let (decoded, _) = EthereumReceipt::<TxType>::from_compact(&data[..], data.len());
    ...
    fn check_transaction_root() {
        ...
        let block =
            alloy_consensus::Block::<EthereumTxEnvelope<TxEip4844>>::decode(block_rlp).unwrap();
    ...
    fn check_withdrawals_root() {
        ...
        let block =
            alloy_consensus::Block::<EthereumTxEnvelope<TxEip4844>>::decode(&mut data.as_slice())
                .unwrap();
    ...
    fn test_receipt_serde() {
        ...
        let receipt: EthereumReceipt<TxType, alloy_rpc_types_eth::Log> =
