...
impl<T: DatabaseAsync> Database for WrapDatabaseAsync<T> {
    ...
    fn storage_by_account_id(
        ...
        self.rt.block_on(self.db.storage_by_account_id_async(address, account_id, storage_key))
    }
...
impl<T: DatabaseAsyncRef> DatabaseRef for WrapDatabaseAsync<T> {
    ...
    fn storage_by_account_id_ref(
        ...
        self.rt.block_on(self.db.storage_by_account_id_async_ref(address, account_id, storage_key))
    }
