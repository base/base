...
/// Build profile name.
pub const BUILD_PROFILE_NAME: &str = env!("BASE_CONSENSUS_BUILD_PROFILE");

/// Short version string.
pub const SHORT_VERSION: &str = env!("BASE_CONSENSUS_SHORT_VERSION");

/// Long version string with additional build info.
pub const LONG_VERSION: &str = concat!(
    env!("BASE_CONSENSUS_LONG_VERSION_0"),
    "\n",
    ...
    "\n",
    env!("BASE_CONSENSUS_LONG_VERSION_4")
);
