...
pub(crate) const DEFAULT_DOWNLOAD_URL: &str = "https://snapshots.base.org/8453";
const SNAPSHOT_API_URL: &str = "https://snapshots.base.org/api/snapshots";
    ...
    pub fn init_snapshots() {
        let download_defaults = DownloadDefaults {
            available_snapshots: vec![
                ...
                Cow::Borrowed("https://snapshots.base.org/84532 (sepolia)"),
                Cow::Borrowed("https://snapshots.base.org/763360 (zeronet)"),
            ],
