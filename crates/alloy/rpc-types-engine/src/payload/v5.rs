...
use super::v4::OpExecutionPayloadV4;
...
/// [`OpExecutionPayloadV4`] (which adds `withdrawalsRoot`), and keeps all other fields identical
/// to the mainnet [`ExecutionPayloadEnvelopeV5`](alloy_rpc_types_engine::ExecutionPayloadEnvelopeV5).
///
/// See also:
/// [execution payload envelope v5] <https://github.com/ethereum-optimism/specs/blob/main/specs/protocol/exec-engine.md#engine_getpayloadv5>
#[derive(Clone, Debug, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "camelCase"))]
pub struct OpExecutionPayloadEnvelopeV5 {
...
mod tests {
    ...
    fn serde_roundtrip_execution_payload_envelope_v5() {
        ...
        let envelope: OpExecutionPayloadEnvelopeV5 = serde_json::from_str(response).unwrap();
