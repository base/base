...
Onchain contract bindings and proof submission for Base dispute games. This crate also owns revert classification, challenge and nullification submissions, and aggregate proof submission through the shared L1 transaction manager.
...
```toml
[dependencies]
base-proof-l1 = { workspace = true }
```

Use the Alloy-backed clients to interact with onchain contracts:

```rust,ignore
use base_proof_l1::DisputeGameFactoryClient;
