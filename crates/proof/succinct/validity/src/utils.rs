...
///
/// ```
/// use base_proof_succinct_validity::find_gaps;
///
/// let overall_start = 1;
/// let overall_end = 10;
/// let ranges = [(2, 5), (7, 9)];
...
///
/// ```ignore
/// use base_proof_succinct_validity::get_ranges_to_prove_by_gas;
...
///
/// ```
/// use base_proof_succinct_validity::get_ranges_to_prove_by_blocks;
///
