...
pub enum HintType {
    ...
    /// execution witness.
    L2PayloadWitness,
    /// A hint that specifies an alt-DA generic commitment whose off-chain batch bytes must be
    /// resolved (via the da-server) and served back to the client.
    AltDaCommitment,
}
...
impl FromStr for HintType {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            ...
            "alt-da-commitment" => Ok(Self::AltDaCommitment),
...
impl From<HintType> for &str {
    fn from(value: HintType) -> Self {
        match value {
            ...
            HintType::AltDaCommitment => "alt-da-commitment",
        }
    }
}
