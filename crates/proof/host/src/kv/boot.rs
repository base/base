...
use base_proof::{
    ALT_DA_ENABLED_KEY, INTERMEDIATE_BLOCK_INTERVAL_KEY, L1_CONFIG_KEY, L1_HEAD_KEY,
    L1_HEAD_NUMBER_KEY, L2_CHAIN_ID_KEY, L2_CLAIM_BLOCK_NUMBER_KEY, L2_CLAIM_KEY,
    L2_OUTPUT_ROOT_KEY, L2_ROLLUP_CONFIG_KEY, L2_SCHEDULE_BLOCK_NUMBER_KEY, PROPOSER_KEY,
};
...
impl KeyValueStore for BootKeyValueStore {
    fn get(&self, key: B256) -> Option<Vec<u8>> {
        ...
        match preimage_key.key_value() {
            ...
            ALT_DA_ENABLED_KEY => Some(vec![u8::from(self.cfg.prover.da_server_url.is_some())]),
            _ => None,
        }
    }
