//! Hint fetching logic for the host.
...
use crate::{HostArgs, HostProviders, SharedKeyValueStore, store_ordered_trie};
...
/// Fetches data in response to a hint, storing results in the key-value store.
pub async fn fetch_hint(
    hint: Hint<HintType>,
    cfg: &HostArgs,
    ...
    match hint.ty {
        ...
        HintType::L2StateNode => {
            ...
            warn!(target: "hint_handler", node_hash = %hash, "L2StateNode hint was sent");
            warn!(
                target: "hint_handler",
