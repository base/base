...
use super::cfg::SingleChainHost;
use crate::{HintHandler, OnlineHostBackendCfg, SharedKeyValueStore, store_ordered_trie};
    ...
    async fn fetch_hint(
        ...
        match hint.ty {
            ...
            HintType::L1Precompile => {
                ...
                let result = crate::precompiles::execute(address, input, gas).map_or_else(
                    |_| vec![0u8; 1],
                    |raw_res| {
            ...
            HintType::L2StateNode => {
                ...
                warn!(target: "single_hint_handler", node_hash = %hash, "L2StateNode hint sent");
                warn!(
            ...
            HintType::L2PayloadWitness => {
                if !cfg.enable_experimental_witness_endpoint {
                    warn!(
                        target: "single_hint_handler",
                        "L2PayloadWitness hint sent but payload witness is disabled, skipping"
                    );
                    return Ok(());
                }
