...
pub use rpc::{
    ...
    OpBlock, ProofCacheKey, ProverL2Client, RethExecutionWitness, RethL2Client, RetryConfig,
    RollupClient, RollupClientConfig, RollupClientImpl, RpcError, RpcResult, SyncStatus,
    create_l2_client,
};
