...
use crate::{
    ...
    OracleL2ChainProvider, OraclePipeline, TrieDBProvider, new_oracle_pipeline_cursor,
    program::{FaultProofDriver, FaultProofProgramError},
};
    ...
    H: HintWriterClient + Send + Sync + Clone + Debug + 'static,
{
    ...
    pub async fn load(self) -> Result<FaultProofDriver<P, H>, FaultProofProgramError> {
