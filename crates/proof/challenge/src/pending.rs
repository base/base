...
use base_zk_client::{GetProofRequest, ProofJobStatus, ProofRequest, ReceiptType, ZkProofProvider};
use tracing::warn;
use uuid::Uuid;
...
pub enum ProofKind {
    ...
    Tee {
        ...
        zk_fallback_request: Option<ProofRequest>,
...
pub enum ProofPhase {
    ...
    /// Proof job failed — the driver should re-initiate `submit_proof`.
    NeedsRetry,
}
...
impl PendingProof {
    ...
    pub fn awaiting(
        ...
        Self {
            ...
            kind: ProofKind::Zk { proof_request },
            invalid_index,
            expected_root,
            retry_count: 0,
            intent,
...
impl PendingProofs {
    ...
    ///   so the driver can re-initiate `submit_proof`.
    ///
