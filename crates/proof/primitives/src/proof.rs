...
pub enum ProofResult {
    ...
    Tee {
        ...
        ///
        /// Stamped by the enclave at signing time so it travels atomically with
        /// the proof, avoiding a separate signer query that could observe a
        /// different key after an enclave restart.
        tee_signer: Address,
    },
