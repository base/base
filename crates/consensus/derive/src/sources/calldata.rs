...
mod tests {
    ...
    pub fn test_legacy_tx(to: Address) -> TxEnvelope {
    ...
    pub fn test_eip2930_tx(to: Address) -> TxEnvelope {
        let sig = Signature::test_signature();
    ...
    pub fn test_eip7702_tx(to: Address) -> TxEnvelope {
        let sig = Signature::test_signature();
    ...
    pub fn test_blob_tx(to: Address) -> TxEnvelope {
        let sig = Signature::test_signature();
    ...
    pub fn default_test_calldata_source() -> CalldataSource<TestChainProvider> {
