...
/// A shorthand syntax for constructing [`base_consensus_batch::Frame`]s.
#[macro_export]
macro_rules! frame {
    ($id:expr, $number:expr, $data:expr, $is_last:expr) => {
        base_consensus_batch::Frame {
            id: [$id; 16],
            number: $number,
            data: $data,
            is_last: $is_last,
...
/// A shorthand syntax for constructing a list of [`base_consensus_batch::Frame`]s.
#[macro_export]
macro_rules! frames {
