...
impl OpP2PApiServer for P2pRpc {
    async fn opp2p_self(&self) -> RpcResult<PeerInfo> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_self");
    ...
    async fn opp2p_peer_count(&self) -> RpcResult<PeerCount> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_peerCount");
        let (tx, rx) = tokio::sync::oneshot::channel();
        self.sender
    ...
    async fn opp2p_peers(&self, connected: bool) -> RpcResult<PeerDump> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_peers");
        let (tx, rx) = tokio::sync::oneshot::channel();
        self.sender
    ...
    async fn opp2p_discovery_table(&self) -> RpcResult<Vec<String>> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_discoveryTable");
        let (tx, rx) = tokio::sync::oneshot::channel();
        self.sender
    ...
    async fn opp2p_block_peer(&self, peer_id: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_blockPeer");
    ...
    async fn opp2p_unblock_peer(&self, peer_id: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_unblockPeer");
        let id = libp2p::PeerId::from_str(&peer_id)
            .map_err(|_| ErrorObject::from(ErrorCode::InvalidParams))?;
        self.sender
    ...
    async fn opp2p_list_blocked_peers(&self) -> RpcResult<Vec<String>> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_listBlockedPeers");
        let (tx, rx) = tokio::sync::oneshot::channel();
        self.sender
    ...
    async fn opp2p_block_addr(&self, address: IpAddr) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_blockAddr");
        self.sender
    ...
    async fn opp2p_unblock_addr(&self, address: IpAddr) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_unblockAddr");
        self.sender
    ...
    async fn opp2p_list_blocked_addrs(&self) -> RpcResult<Vec<IpAddr>> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_listBlockedAddrs");
        let (tx, rx) = tokio::sync::oneshot::channel();
        self.sender
    ...
    async fn opp2p_block_subnet(&self, subnet: IpNet) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_blockSubnet");
        self.sender
    ...
    async fn opp2p_unblock_subnet(&self, subnet: IpNet) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_unblockSubnet");
    ...
    async fn opp2p_protect_peer(&self, id: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_protectPeer");
    ...
    async fn opp2p_unprotect_peer(&self, id: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_unprotectPeer");
        let peer_id = libp2p::PeerId::from_str(&id)
            .map_err(|_| ErrorObject::from(ErrorCode::InvalidParams))?;
        self.sender
    ...
    async fn opp2p_connect_peer(&self, _peer: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_connectPeer");
    ...
    async fn opp2p_disconnect_peer(&self, peer_id: String) -> RpcResult<()> {
        base_metrics::inc!(gauge, base_consensus_gossip::Metrics::RPC_CALLS, "method" => "opp2p_disconnectPeer");
