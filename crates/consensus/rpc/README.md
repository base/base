...
```toml
[dependencies]
base-rpc = { git = "https://github.com/base/base" }
```
...
```rust,ignore
use base_rpc::SyncStatusApiServer;
...
```toml
[dependencies]
base-rpc = { git = "https://github.com/base/base", features = ["client"] }
```

```rust,ignore
use base_rpc::SyncStatusApiClient;
