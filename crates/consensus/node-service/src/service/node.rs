//! Contains the [`BaseNode`] implementation.
...
/// The Base rollup node service, using the governance approved OP Stack configuration of
/// components.
#[derive(Debug)]
pub struct BaseNode {
...
impl BaseNode {
    ...
    /// Starts the Base node service.
    ///
    /// The node, in validator mode, listens to two sources of information to sync the L2 chain:
    ///
    ...
    pub async fn start(&self) -> Result<(), String> {
        ...
        // Select the concrete derivation actor implementation based on BaseNode configuration.
