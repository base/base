...
pub use config::{
    ...
    DEFAULT_PENDING_DIAL_TIMEOUT, GATER_PRUNE_INTERVAL, GLOBAL_VALIDATE_THROTTLE, GOSSIP_HEARTBEAT,
    MAX_GOSSIP_SIZE, MAX_OUTBOUND_QUEUE, MAX_VALIDATE_QUEUE, MIN_GOSSIP_SIZE,
    PEER_SCORE_INSPECT_FREQUENCY, PENDING_DIAL_PRUNE_INTERVAL, SEEN_MESSAGES_TTL, default_config,
