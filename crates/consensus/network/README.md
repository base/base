# `base-consensus-network`

<a href="https://crates.io/crates/base-consensus-network"><img src="https://img.shields.io/crates/v/base-consensus-network.svg?label=base-consensus-network&labelColor=2a2f35" alt="base-consensus-network"></a>

## Overview

Consensus peer identities, bootnode storage, discovery v5, and payload gossip.
...
```toml
[dependencies]
base-consensus-network = { workspace = true }
```
