...
use base_consensus_genesis::{
    BASE_MAINNET_BASE_FEE_CONFIG, ChainGenesis, FeatureMap, HardForkConfig, RollupConfig,
    SystemConfig,
};

/// Returns the [`RollupConfig`] for Base Mainnet.
pub fn base_mainnet_config() -> RollupConfig {
    RollupConfig {
