...
use base_consensus_genesis::{
    BASE_SEPOLIA_BASE_FEE_CONFIG, ChainGenesis, FeatureMap, HardForkConfig, RollupConfig,
    SystemConfig,
};

/// Returns the [`RollupConfig`] for Base Sepolia.
pub fn base_sepolia_config() -> RollupConfig {
    RollupConfig {
