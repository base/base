...
mod tests {
    ...
    fn sub_second_floors_wall_clock_to_cadence() {
        let planned = SequencerTimestampPlanner::sub_second(1_000_000, 1_000_450, 200).unwrap();
    ...
    fn sub_second_enforces_monotonic_minimum() {
        let planned = SequencerTimestampPlanner::sub_second(1_000_000, 1_000_050, 200).unwrap();
    ...
    fn sub_second_carries_across_second_boundary() {
        let planned = SequencerTimestampPlanner::sub_second(1_999_800, 2_000_050, 200).unwrap();
