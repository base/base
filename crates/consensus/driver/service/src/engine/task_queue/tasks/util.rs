...
use crate::engine::{Engine, EngineClient, EngineState, InsertPayloadSafety};

/// Error type for build and seal operations.
#[derive(Debug, thiserror::Error)]
pub(in crate::engine::task_queue) enum BuildAndSealError {
...
pub(in crate::engine::task_queue) async fn build_and_seal<EngineClient_: EngineClient>(
