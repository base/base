...
use base_consensus_driver::{
    ...
    L1WatcherQueries, L1WatcherQueryExecutor, NodeActor,
};
use base_consensus_source::{AlloyChainProviderError, ConfDepthProvider, L1HeadNumber};
use futures::Stream;
...
async fn l1_watcher_and_conf_depth_provider_end_to_end() {
    ...
    let dummy_inner = base_consensus_source::AlloyChainProvider::new(
