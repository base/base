...
use base_common_types_rpc::{BaseTransaction, Block as RpcBlock};
...
///
/// [`base_consensus_batch::L2BlockInfoDecoder::from_block_and_genesis`]: base_consensus_batch::L2BlockInfoDecoder::from_block_and_genesis
