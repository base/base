...
use base_consensus_batch::{AttributesWithParent, BaseBlockConversionError, L2BlockInfo};
use thiserror::Error;
...
impl<EngineClient_: EngineClient> Engine<EngineClient_> {
    ...
    /// [`crate::engine::find_starting_forkchoice`]. The state will be updated to the starting point, and a
...
mod tests {
    ...
    fn test_engine() -> Engine<crate::engine::test_utils::MockEngineClient> {
