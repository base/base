...
use base_consensus_network::{
    BootNodes, BootStoreFile, ConnectionLimitsConfig, GaterConfig, LocalNode, PeerMonitoring,
    PeerScoreLevel,
};
    ...
    pub fn new(
        ...
        Self {
            ...
            max_identify_peerstore_peers:
                base_consensus_network::DEFAULT_MAX_IDENTIFY_PEERSTORE_PEERS,
            gossip_config: base_consensus_network::default_config(),
