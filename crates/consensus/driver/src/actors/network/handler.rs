...
use base_consensus_network::{
    BlockHandler, ConnectionGate, ConnectionGater, Discv5Handler, GossipDriver, GossipMetrics,
    HandlerRequest, P2pRpcRequest,
};
use base_consensus_source::BlockSignerHandler;
use discv5::Enr;
use tokio::{
    select,
    sync::{mpsc, watch},
