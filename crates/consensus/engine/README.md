...
- **Rollup Schedule Validation**: [`InsertTask`](crate::InsertTask) validates Denim payload timestamps against the absolute rollup schedule before calling `engine_newPayload`.
