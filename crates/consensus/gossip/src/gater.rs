...
impl ConnectionGate for ConnectionGater {
    fn can_dial(&mut self, addr: &Multiaddr) -> Result<(), DialError> {
        ...
        let peer_id = Self::peer_id_from_addr(addr).ok_or_else(|| {
            ...
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "invalid_multiaddr");
        ...
        if self.current_dials.contains(&peer_id) {
            ...
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "already_dialing", "peer" => peer_id.to_string());
        ...
        if !protected && self.dial_threshold_reached(addr) && !self.dial_period_expired(addr) {
            ...
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "threshold_reached", "peer" => peer_id.to_string());
        ...
        if self.blocked_peers.contains(&peer_id) {
            ...
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "blocked_peer", "peer" => peer_id.to_string());
        ...
        if self.blocked_addrs.contains(&ip_addr) {
            ...
            self.connectedness.insert(peer_id, Connectedness::CannotConnect);
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "blocked_address", "peer" => peer_id.to_string());
        ...
        if self.check_ip_in_blocked_subnets(&ip_addr) {
            ...
            base_metrics::inc!(gauge, crate::Metrics::DIAL_PEER_ERROR, "type" => "blocked_subnet", "peer" => peer_id.to_string());
