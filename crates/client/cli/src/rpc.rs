...
impl RpcArgs {
    /// Returns the socket address to bind the RPC server to.
...
mod tests {
    ...
    #[case::addr(&["--rpc.addr", "1.1.1.1"], |args: &mut RpcArgs| { args.listen_addr = IpAddr::V4(Ipv4Addr::new(1, 1, 1, 1)); })]
    #[case::port(&["--port", "8743"], |args: &mut RpcArgs| { args.listen_port = 8743; })]
    #[case::port_alias(&["--rpc.port", "8743"], |args: &mut RpcArgs| { args.listen_port = 8743; })]
