...
use reth::{
    ...
    revm::{
        ...
        bytecode::Bytecode,
        db::{AccountState, BundleState, Cache, CacheDB, DbAccount, State},
...
fn layering_cachedb_wrapping_state_loses_writes() -> eyre::Result<()> {
    ...
    wrong_db.db.merge_transitions(BundleRetention::Reverts);
    ...
    let mut state_changes2 = EvmState::default();
    ...
    correct_db.merge_transitions(BundleRetention::Reverts);
