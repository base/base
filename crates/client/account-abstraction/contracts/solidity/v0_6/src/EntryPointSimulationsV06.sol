...
// This is based on Pimlico's EntryPointCodeOverride.sol
// https://github.com/pimlicolabs/contracts/blob/main/src/v06/EntryPointCodeOverride.sol
//
...
// Changes from original v0.6 EntryPoint:
// - Hardcode senderCreator address
// - Renamed to EntryPointSimulationsV06
// - Throw custom error CallPhaseReverted if callphase reverts
// - Throw custom error FailedOpWithRevert for postOp reverts with inner reason
...
contract EntryPointSimulationsV06 is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard {
    ...
    */
     ...
     */
    function _handlePostOp(uint256 opIndex, IPaymaster.PostOpMode mode, UserOpInfo memory opInfo, bytes memory context, uint256 actualGas)
