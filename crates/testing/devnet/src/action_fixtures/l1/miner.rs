...
pub struct L1Block {
    ...
    /// [`ActionBlobProvider`](crate::action_fixtures::ActionBlobProvider) looks them up by hash.
...
impl L1Miner {
    ...
    /// the next block is mined. [`ActionBlobProvider`](crate::action_fixtures::ActionBlobProvider)
