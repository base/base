...
/// submission. Blobs are stored in [`L1Block::blob_sidecars`](crate::action_fixtures::L1Block)
/// when enqueued via [`L1Miner::enqueue_blob`](crate::action_fixtures::L1Miner::enqueue_blob)
