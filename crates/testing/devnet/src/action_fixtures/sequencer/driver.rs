...
/// default for deterministic protocol tests; use [`BuilderBackedEngineClient`](crate::action_fixtures::BuilderBackedEngineClient)
...
/// instead (see [`BuilderBackedEngineClient`](crate::action_fixtures::BuilderBackedEngineClient)).
...
mod tests {
    use super::*;
    use crate::action_fixtures::{
        ActionTestHarness, BatcherConfig, L1MinerConfig, TestRollupConfigBuilder,
    };
