...
use base_consensus_batch::{AttributesWithParent, BlockInfo, L1BlockInfoTx, L2BlockInfo};
...
use base_consensus_driver::{
    EngineClient, SafeDB, SafeDBError, SafeDBReader, SafeHeadListener, SafeHeadResponse,
};
...
/// [`ActionTestHarness::create_test_rollup_node`]: crate::action_fixtures::ActionTestHarness::create_test_rollup_node
/// [`L2Sequencer`]: crate::action_fixtures::L2Sequencer
#[derive(Debug)]
...
impl<P: Pipeline + SignalReceiver + Debug + Send> TestRollupNode<P> {
    ...
    /// sequencer.
    ///
    /// [`create_test_rollup_node`]: crate::action_fixtures::ActionTestHarness::create_test_rollup_node
