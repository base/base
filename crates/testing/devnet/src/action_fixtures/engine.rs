...
impl ActionEngineClient {
    ...
    pub fn build_genesis_for_rollup(rollup_config: &RollupConfig) -> Genesis {
        ...
        genesis.alloc.insert(
            crate::action_fixtures::TEST_ACCOUNT_ADDRESS,
        ...
        genesis.config.extra_fields.insert(
            ...
            serde_json::json!(crate::action_fixtures::TEST_ACCOUNT_ADDRESS),
        );
...
impl crate::action_fixtures::SequencerEngineBackend for ActionEngineClient {
