...
#[cfg(feature = "upgrade-signal")]
use crate::system_fixtures::upgrade_signal::{
    MockProtocolVersionsClient, UpgradeSignalStackOptions,
};
use crate::system_fixtures::{
...
impl SystemTestStack {
    ...
    pub async fn urls(&self) -> Result<crate::system_fixtures::SystemTestUrls> {
        Ok(crate::system_fixtures::SystemTestUrls {
