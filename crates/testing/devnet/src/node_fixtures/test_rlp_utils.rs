...
pub fn generate_test_blocks(chain_spec: &BaseChainSpec, count: u64) -> Vec<SealedBlock> {
    ...
    for i in 1..=count {
        ...
        let mut header = Header {
            ...
            receipts_root: base_common_types_chain::constants::EMPTY_RECEIPTS,
            ...
            transactions_root: base_common_types_chain::constants::EMPTY_TRANSACTIONS,
            ommers_hash: base_common_types_chain::constants::EMPTY_OMMER_ROOT_HASH,
            mix_hash: B256::ZERO,
            nonce: B64::from(0u64),
