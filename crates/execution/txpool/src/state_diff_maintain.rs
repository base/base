...
use base_execution_evm_runtime::{BundleState, NonceManagerStorage};
...
mod tests {
    ...
    use base_execution_evm_runtime::{AccountInfo, BundleAccount, HashMap, StorageSlot};
    ...
    fn account(
        ...
        let mut account = BundleAccount {
            ...
            status: base_execution_evm_runtime::AccountStatus::Changed,
        };
