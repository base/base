...
use base_common_types_chain::{
    BaseTxEnvelope, EthereumTxEnvelope, SignableTransaction, Signed, SignedTransaction, TxEip1559,
    TxEip4844, TxLegacy, crypto::secp256k1::sign_message,
};
...
impl<R: RngCore> TransactionGenerator<R> {
    ...
    /// Creates a new transaction with a random signer
    pub fn gen_eip4844(&mut self) -> EthereumTxEnvelope<TxEip4844> {
