    ...
    S: BlobStore + Clone,
{
    ...
    pub fn admission_for(transaction: &T) -> Option<Admission> {
        ...
        Some(Admission {
            ...
            sender_delegate: class.sender_delegate,
            sender_delegate_locked: class.sender_delegate_locked,
            payer_locked: class.payer_locked,
            payer_delegate: class.payer_delegate,
            payer_delegate_locked: class.payer_delegate_locked,
