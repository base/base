...
use crate::{BasePooledTransaction, ExtensionError};
...
impl TransactionValidity {
    ...
    pub fn validate(&self, max_items: usize) -> Result<(), ExtensionError> {
    ...
    pub fn extract(tx: &ValidPoolTransaction) -> Self {
    ...
    pub fn apply(self, tx: BasePooledTransaction) -> Result<BasePooledTransaction, ExtensionError> {
