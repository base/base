...
use base_common_types_chain::{
    ...
    Eip8130Signed, InMemorySize, SignedTransaction, Transaction, Typed2718, transaction::Recovered,
};
...
impl BasePooledTransaction {
    ...
    pub fn estimated_compressed_size(&self) -> u64 {
        *self.estimated_tx_compressed_size.get_or_init(|| {
            base_common_chain_config::tx_estimated_size_fjord_bytes(self.encoded_2718())
        })
    }
...
mod tests {
    ...
    use base_common_types_chain::{
        ...
        Eip8130Constants, Eip8130Signed, EthereumTxEnvelope, InMemorySize, SignableTransaction,
        TxDeposit, TxEip1559, TxEip2930, TxEip4844, TxEip7702, TxEip8130, TxLegacy,
