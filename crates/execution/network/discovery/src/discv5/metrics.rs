...
pub struct DiscoveredPeersMetrics {
    ...
    // Kbuckets
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// Total peers currently in [`crate::Discv5Protocol`]'s kbuckets.
    kbucket_peers_raw_total: Gauge,
    /// Total discovered peers that are inserted into [`crate::Discv5Protocol`]'s kbuckets.
    ///
    ...
    /// it into [`crate::Discv5Protocol`]'s kbuckets and will hence be included in queries.
    ///
    /// Note: the definition of 'discovered' is not exactly synonymous in `crate::Discv4`.
    inserted_kbucket_peers_raw_total: Counter,

    ////////////////////////////////////////////////////////////////////////////////////////////////
    // Sessions
    ////////////////////////////////////////////////////////////////////////////////////////////////
    /// Total peers currently connected to [`crate::Discv5Protocol`].
    sessions_raw_total: Gauge,
    /// Total number of sessions established by [`crate::Discv5Protocol`].
    established_sessions_raw_total: Counter,
    /// Total number of sessions established by [`crate::Discv5Protocol`], with peers that don't advertise
    /// a socket which is reachable from the local node in their node record.
    ///
    /// These peers can't make it into [`crate::Discv5Protocol`]'s kbuckets, and hence won't be part of
    ...
    /// Total number of sessions established by [`crate::Discv5Protocol`], that pass configured
    /// [`filter`](crate::discv5::filter) rules.
    established_sessions_custom_filtered_total: Counter,
    /// Total number of unverifiable ENRs discovered by [`crate::Discv5Protocol`].
    ///
    /// These are peers that fail [`crate::Discv5Protocol`] session establishment, because the UDP socket
...
impl DiscoveredPeersMetrics {
    ...
    /// Increments number of sessions established by [`crate::Discv5Protocol`], that pass configured
    /// [`filter`](crate::discv5::filter) rules.
    pub fn increment_established_sessions_filtered(&self, num: u64) {
        self.established_sessions_custom_filtered_total.increment(num)
    }

    /// Increments number of unverifiable ENRs discovered by [`crate::Discv5Protocol`]. These are peers
...
impl AdvertisedChainMetrics {
    ...
    pub fn increment_once_by_network_type(&self, enr: &crate::Enr) {
