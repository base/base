use enr::{NodeId, k256::sha2::digest::generic_array::GenericArray};
use smallvec::SmallVec;
use tokio::sync::oneshot;

use crate::discv5_protocol::{Enr, kbucket::Key, rpc::RequestBody};
...
impl crate::discv5_protocol::query_pool::TargetKey<NodeId> for QueryInfo {
