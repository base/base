...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(any(test, feature = "arbitrary"), derive(arbitrary::Arbitrary))]
pub struct BlockHeaders<H = base_common_types_chain::Header>(
    /// The requested headers.
    pub Vec<H>,
);

generate_tests!(#[rlp, 10] BlockHeaders<base_common_types_chain::Header>, EthBlockHeadersTests);
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(any(test, feature = "arbitrary"), derive(arbitrary::Arbitrary))]
pub struct BlockBodies<B = base_common_types_chain::BlockBody<EthereumTxEnvelope<TxEip4844>>>(
    /// The requested block bodies, each of which should correspond to a hash in the request.
    pub Vec<B>,
);

generate_tests!(#[rlp, 16] BlockBodies<base_common_types_chain::BlockBody::<base_common_types_chain::EthereumTxEnvelope::<base_common_types_chain::TxEip4844>>>, EthBlockBodiesTests);
