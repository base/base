...
use crate::{
    Capability, EthMessageID, EthVersion, MAX_RESERVED_MESSAGE_ID, P2PHandshakeError,
    P2PStreamError, ParseVersionError, ProtoVersion, Protocol,
};
...
mod tests {
    ...
    use super::*;
    use crate::{Capabilities, Capability, RawCapabilityMessage, SnapVersion};
