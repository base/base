...
use crate::peer_types::{
    DEFAULT_REPUTATION, NodeRecord, PeerAddr, PeerConnectionState, PeerId, PeerKind,
    ReputationChangeKind, ReputationChangeOutcome, is_banned_reputation,
};
...
pub struct Peer {
    ...
    /// [`BackoffKind`](crate::peer_types::BackoffKind).
