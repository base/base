...
pub struct TransactionFetcherConfig {
    /// Max inflight [`GetPooledTransactions`](base_execution_network_wire::GetPooledTransactions) requests.
    pub max_inflight_requests: u32,
    /// Max inflight [`GetPooledTransactions`](base_execution_network_wire::GetPooledTransactions) requests per
    /// peer.
    ...
    /// [`GetPooledTransactions`](base_execution_network_wire::GetPooledTransactions) request. Spec'd at 2
    /// MiB.
    pub soft_limit_byte_size_pooled_transactions_response: usize,
    /// Soft limit for the byte size of the expected
    /// [`PooledTransactions`](base_execution_network_wire::PooledTransactions) response on packing a
    /// [`GetPooledTransactions`](base_execution_network_wire::GetPooledTransactions) request with hashes.
    ...
    /// [`GetPooledTransactions`](base_execution_network_wire::GetPooledTransactions) yet, or it wasn't returned
