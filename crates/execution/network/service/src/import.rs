...
use base_execution_network_wire::{NewBlock, NewBlockHashes, PeerId};
...
#[derive(Debug)]
pub enum BlockImportEvent<B = base_common_types_chain::Block<EthereumTxEnvelope<TxEip4844>>> {
...
#[derive(Debug)]
pub struct BlockImportOutcome<B = base_common_types_chain::Block<EthereumTxEnvelope<TxEip4844>>> {
...
pub enum BlockImportError {
    /// Consensus error
    #[error(transparent)]
    Consensus(#[from] base_execution_evm_blocks::ConsensusError),
    /// Other error
    #[error(transparent)]
