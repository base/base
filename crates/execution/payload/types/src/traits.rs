...
/// Generates the payload id for the configured payload from the [`base_common_types_payload::PayloadAttributes`].
///
/// Returns an 8-byte identifier by hashing the payload components with sha256 hash.
pub fn payload_id(
    parent: &B256,
    attributes: &base_common_types_payload::PayloadAttributes,
) -> PayloadId {
    use sha2::Digest;
