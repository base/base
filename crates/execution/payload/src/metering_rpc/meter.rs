...
use base_common_types_chain::{BlockHeader, SealedHeader, Transaction as _};
...
impl PseudoOpcode {
    ...
    /// `base-execution-payload::ResourceSample`.
...
mod tests {
    ...
    use base_common_types_payload::{Bundle, ParsedBundle};
    use base_execution_evm_runtime::{
        Account as RevmAccount, ActivationFeature, EvmStorageSlot, IActivationRegistry, IB20,
        IB20Factory, IB20Stablecoin, IPolicyRegistry, TransactionId,
    };
