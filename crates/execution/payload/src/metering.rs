...
impl MeteringStore {
    ...
    /// payload inclusion.
    pub fn mark_included_without_metering(&self, tx_hash: &TxHash) {
    ...
    pub fn skip(&self, tx_hash: &TxHash) {
    ...
    pub fn remove(&self, tx_hashes: &[TxHash]) {
...
/// Shared metering cache used by payload building and RPC.
pub type SharedMeteringStore = Arc<MeteringStore>;
