...
impl<N: NodePrimitives> From<BaseBuiltPayload<N>>
    for base_common_rpc_types_engine::TracedExecutionData
where
    N::SignedTx: SignedTransaction,
{
    fn from(value: BaseBuiltPayload<N>) -> Self {
        Self::new(base_common_rpc_types_engine::ExecutionData::from(value))
    }
}
