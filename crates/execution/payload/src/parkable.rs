...
pub use base_execution_txpool::NoopPayloadTransactions;
use base_execution_txpool::{
    BasePooledTransaction, BestTransactions, InvalidPoolTransactionError, ParkableBestTransactions,
    PayloadTransactions, PoolTransactionError, ValidPoolTransaction,
};
...
impl<I> ParkablePayloadTransactions for base_execution_txpool::BestPayloadTransactions<I>
where
...
impl ParkablePayloadTransactions
    for base_execution_txpool::NoopPayloadTransactions<base_execution_txpool::BasePooledTransaction>
{
    fn park_current(&mut self) -> bool {
        false
    }
