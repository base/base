...
use base_execution_state_types::{
    BlockExecutionOutput, BlockReader, ExecutionWitnessMode, ProviderError, StateProvider,
    StateProviderFactory,
};
use base_execution_txpool::{
    BasePooledTransaction, BestTransactionsAttributes, DataAvailabilitySized, GuardMetrics,
    NoopPayloadTransactions, ParkableTransactionPool, PayloadTransactions, PredicateContext,
    TransactionPool,
};
...
use crate::{
    ...
    is_better_payload, payload::BaseBuiltPayload,
};
...
impl Clone for BasePayloadBuilder {
    fn clone(&self) -> Self {
        Self {
...
impl<Txs> Builder<'_, Txs> {
    ...
    pub fn witness(
        ...
        header_provider: impl base_execution_state_types::HeaderProvider,
        ctx: &BasePayloadBuilderCtx,
    ) -> Result<ExecutionWitness, PayloadBuilderError>
    where
...
mod tests {
    ...
    fn included_tx_count(outcome: BuildOutcomeKind) -> usize {
        match outcome {
