...
mod tests {
    ...
    use alloy_primitives::{Address, B256, Bytes, Log, LogData, b256, bloom, hex};
    use base_alloy_consensus::OpDepositReceipt;
    use base_execution_chainspec::{BASE_MAINNET, BASE_SEPOLIA};
    ...
    #[test]
    fn check_base_mainnet_receipt_root_block_42969982() {
        let json: Vec<serde_json::Value> = serde_json::from_str(include_str!(
            "testdata/base_mainnet_42969982_receipts.json"
        ))
        .unwrap();
