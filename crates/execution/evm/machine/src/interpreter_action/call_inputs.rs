...
use base_execution_evm_primitives::{Address, B256, Bytes, U256};
...
pub enum CallInput {
    ...
    Bytes(Bytes),
    /// The Range points to the SharedMemory buffer. Buffer can be found in [`base_execution_evm_machine::LocalContextTr::shared_memory_buffer_slice`] function.
    ...
    /// recommendation is to fetch buffer at first Inspector call and clone it from [`base_execution_evm_machine::LocalContextTr::shared_memory_buffer_slice`] function.
