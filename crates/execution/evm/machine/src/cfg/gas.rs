...
mod tests {
    ...
    fn new_used_gas_saturates_remaining_at_zero() {
        assert_eq!(GasTracker::new_used_gas(10, 9, 3), GasTracker::new(10, 1, 3));
        assert_eq!(GasTracker::new_used_gas(10, 10, 3), GasTracker::new(10, 0, 3));
        assert_eq!(GasTracker::new_used_gas(10, 11, 3), GasTracker::new(10, 0, 3));
    }
}
...
impl InitialAndFloorGas {
    ...
    pub const fn new(initial_regular_gas: u64, floor_gas: u64) -> Self {
        Self { initial_regular_gas, initial_state_gas: 0, floor_gas }
    }
    ...
    pub const fn new_with_state_gas(
        ...
        Self { initial_regular_gas, initial_state_gas, floor_gas }
    }
    ...
    pub fn initial_gas_and_reservoir(
        ...
        let tx_gas_limit_cap =
            if self.initial_total_gas() == 0 { u64::MAX } else { tx_gas_limit_cap };
