...
pub trait Handler {
    ...
    fn run_system_call(
        ...
        match self.execution(evm, checkpoint, &mut gas).and_then(|exec_result| {
    ...
    fn validate_initial_tx_gas(
        ...
        let eip2780 = is_amsterdam_eip2780_enabled.then(|| {
            ...
            gas_params::Eip2780TxInfo { value: tx.value(), is_self_transfer }
        });
    ...
    fn first_frame_input(
        ...
        Ok(Some(FrameInit { depth: 0, memory, frame_input }))
    }
