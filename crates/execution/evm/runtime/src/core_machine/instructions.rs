...
pub use crate::core_machine::{
    ...
    calculate_initial_tx_gas_for_tx, gas, get_tokens_in_calldata, get_tokens_in_calldata_istanbul,
};
use crate::{
    core_machine::{Host, InstructionContext, InstructionExecResult},
    hardfork::SpecId,
};
...
pub const fn gas_table_spec(spec: SpecId) -> GasTable {
    ...
    if spec.is_enabled_in(AMSTERDAM) {
        ...
        let warm = crate::eip8038::WARM_ACCESS as u16;
...
mod tests {
    ...
    use crate::{core_machine::DummyHost, opcode::*};
