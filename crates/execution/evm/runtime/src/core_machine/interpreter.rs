...
// imports
use crate::core_machine::Gas;
use crate::{
    Bytecode, Bytes,
    core_machine::{
        GasParams, GasTable, Host, InstructionExecResult, InstructionResult, InstructionTable,
        InterpreterAction, LoadError, instruction_context::InstructionContext,
    },
    hardfork::SpecId,
...
pub fn asm_run(
    ...
    host: &mut crate::core_machine::DummyHost,
) {
    let table = crate::core_machine::instruction_table();
    let gas_table = crate::core_machine::gas_table();
