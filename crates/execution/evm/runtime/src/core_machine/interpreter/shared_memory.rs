...
pub use crate::core_machine::num_words;
use crate::{
    B256, U256,
    core_machine::{GasParams, InstructionResult},
    hex,
};
...
pub struct SharedMemory {
    ...
    /// Memory limit. See [`Cfg`](crate::core_machine::Cfg).
...
impl SharedMemory {
    ...
    pub fn resize(&mut self, new_size: usize) {
        self.buffer().dbg_borrow_mut().resize(self.my_checkpoint + new_size, 0);
    }
    ...
    pub fn global_to_local_set_data(
        ...
        let src = if data_range.is_empty() { &mut [] } else { src.get_mut(data_range).unwrap() };
...
pub fn resize_memory(
    gas: &mut crate::core_machine::Gas,
...
mod tests {
    ...
    fn resize_memory_limit() {
        ...
        let mut gas = crate::core_machine::Gas::new(100_000);
