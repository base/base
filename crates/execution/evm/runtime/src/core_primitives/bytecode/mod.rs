...
use crate::core_primitives::{
    Address, B256, BytecodeDecodeError, Bytes, JumpTable, KECCAK_EMPTY, OnceLock,
...
impl Bytecode {
    ...
    #[inline]
    pub fn iter_opcodes(&self) -> crate::core_primitives::BytecodeIterator<'_> {
        crate::core_primitives::BytecodeIterator::new(self)
    }
}
...
mod tests {
    ...
    use super::*;
    use crate::core_primitives::{bytes, eip7702::Eip7702DecodeError, opcode};
    ...
    fn eip7702_sanity_decode() {
        ...
        assert_eq!(Bytecode::new_eip7702_raw(raw), Err(Eip7702DecodeError::UnsupportedVersion));
    ...
    fn eip7702_invalid_magic() {
        ...
        assert_eq!(Bytecode::new_eip7702_raw(raw1), Err(Eip7702DecodeError::InvalidMagic));

        let raw2 = bytes!("ef0001deadbeef00000000000000000000000000000000");
        assert_eq!(Bytecode::new_eip7702_raw(raw2), Err(Eip7702DecodeError::InvalidMagic));
    }
    ...
    fn new_raw_checked_dispatch() {
        ...
        assert_eq!(
            ...
            Err(BytecodeDecodeError::Eip7702(Eip7702DecodeError::InvalidLength))
        );
