...
mod tests {
    ...
    fn derived_relations() {
        ...
        assert_eq!(STORAGE_CLEAR_REFUND, (STORAGE_WRITE + COLD_STORAGE_ACCESS) * 4_800 / 5_000);
        assert_eq!(COLD_ACCOUNT_ACCESS_ADDITIONAL, COLD_ACCOUNT_ACCESS - WARM_ACCESS);
        assert_eq!(COLD_STORAGE_ACCESS_ADDITIONAL, COLD_STORAGE_ACCESS - WARM_ACCESS);
    }
}
