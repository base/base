...
use crate::core_precompiles::{
    BasePrecompileError, INonceManager, INonceManager::INonceManagerCalls as C,
    IntoPrecompileResult, PrecompileResult, StorageCtx, macros::decode_precompile_call,
...
/// *output* words at `W_copy` (see [`crate::core_precompiles::tx_context::dispatch`]), so the two
...
impl NonceManagerStorage<'_> {
    ...
    fn inner(&self, calldata: &[u8]) -> crate::core_precompiles::Result<Bytes> {
...
mod tests {
    ...
    use crate::core_precompiles::{
        HashMapStorageProvider, INonceManager, NonceManagerStorage, StorageCtx,
    };
    ...
    fn dispatch(
        ...
        calldata: &[u8],
    ) -> crate::core_precompiles::PrecompileOutput {
    ...
    fn gas_matches_evm_reference() {
        assert_eq!(super::CALLDATA_WORD_GAS, crate::gas::KECCAK256WORD);
    }
