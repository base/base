...
use crate::core_precompiles::{
    BasePrecompileError, Handler, INonceManager, Mapping, Result, StorageKey,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        BasePrecompileError, Handler, HashMapStorageProvider, INonceManager, StorageCtx,
        StorageKey, nonce::storage::NonceManagerStorage,
    };
