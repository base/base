...
use crate::{
    AccountInfo, Bytecode, GasParams, JournalCheckpoint,
    core_precompiles::{
        PrecompileInput,
        error::{BasePrecompileError, Result},
        storage_provider::{
            PrecompileStorageProvider, StorageFeatures, validate_loaded_code_presence,
        },
    },
    gas::{Gas, KECCAK256, KECCAK256WORD, LOG},
    keccak256,
};
...
pub struct EvmPrecompileStorageProvider<'a> {
    internals: crate::core_precompiles::EvmInternals<'a>,
    caller: Address,
    call_value: U256,
    gas: Gas,
...
impl From<crate::core_precompiles::EvmInternalsError> for BasePrecompileError {
    fn from(e: crate::core_precompiles::EvmInternalsError) -> Self {
...
mod tests {
    ...
    use crate::{
        Bytecode, EmptyDB, EthEvmContext, GasParams,
        core_precompiles::{
            BytesLikeHandler, EvmInternals, Handler, PrecompileInput, StorageCtx,
