...
use crate::core_precompiles::{
    AssetAccounting, AssetCall, AssetVersion, AssetVersions, B20AssetStorage, B20AssetToken,
    B20PolicyType, B20TokenRole, BasePrecompileError, IB20, IB20::IB20Calls as C, IB20Asset,
    IB20Asset::IB20AssetCalls as SC, NoopPrecompileCallObserver, PermitArgs, PolicyAccounting,
    PrecompileAuxiliaryMetrics, PrecompileCallObserver, PrecompileCallRecorder,
    PrecompileMetricLabels, PrecompileResult, StorageCtx,
};
...
impl<S: AssetAccounting, A: PolicyAccounting> B20AssetToken<S, A> {
    ...
    /// authorized [`Asset::grant_role`](crate::core_precompiles::Asset) path is not yet reachable.
    ...
    pub fn route<O>(
        ...
        privileged: bool,
        observer: O,
    ) -> crate::core_precompiles::Result<Bytes>
    where
        O: PrecompileCallObserver,
    {
...
mod tests {
    ...
    use crate::core_precompiles::{
        ...
        HashMapStorageProvider, IB20, IB20Asset, InMemoryTokenAccounting,
        NoopPrecompileCallObserver, PolicyVersion, PrecompileCallMetric, PrecompileCallObserver,
        PrecompileCallOutcome, PrecompileCallStatus, PrecompileErrorKind, Result, StorageCtx,
    ...
    fn announce_inner_system_error_propagates_unchanged() {
        ...
        assert_eq!(err, crate::core_precompiles::BasePrecompileError::under_overflow());
    }
    ...
    fn announce_inner_ordinary_revert_wraps_as_internal_call_failed() {
        ...
        assert_eq!(
            err,
            crate::core_precompiles::BasePrecompileError::revert(IB20Asset::InternalCallFailed {
                call: inner_call
            })
        );
    }
    ...
    fn route_v1_rejects_scheduled_selector_as_unknown() {
        ...
        assert_eq!(
            err,
            crate::core_precompiles::BasePrecompileError::UnknownFunctionSelector(selector)
        );
    }
            ...
            for version in [AssetVersion::V1, AssetVersion::V2] {
                ...
                if let Err(err) = outcome {
                    ...
                    if rejects_via_valid_token && version == AssetVersion::V2 {
                        ...
                        assert_eq!(
                            err,
                            crate::core_precompiles::BasePrecompileError::AbiDecodeFailed {
                    ...
                    match err {
                        ...
                        crate::core_precompiles::BasePrecompileError::UnknownFunctionSelector(
                            _,
                        ) => {}
