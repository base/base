...
use crate::core_precompiles::{
    AssetAccounting, PolicyAccounting, PolicyRegistryLogic, PolicyVersion, Token,
};
...
/// implementations resolved from [`crate::core_precompiles::AssetVersions`]. Authorization goes
