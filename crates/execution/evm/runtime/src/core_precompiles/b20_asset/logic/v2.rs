...
use crate::core_precompiles::{
    ...
    B20PausableFeature, B20PolicyType, B20TokenRole, BasePrecompileError, Eip712Domain, IB20,
    IB20Asset, NonZeroAddress, PermitArgs, PolicyAccounting, Result, Token, TransferPolicyIds,
};
...
impl<S: AssetAccounting, A: PolicyAccounting> Asset<S, A> for AssetV2 {
    ...
    fn supports_interface(&self, interface_id: FixedBytes<4>) -> Result<bool> {
        Ok(interface_id == crate::core_precompiles::ERC165_INTERFACE_ID
            || crate::core_precompiles::ERC8056_INTERFACE_IDS.contains(&interface_id))
    }
...
mod tests {
    ...
    use crate::core_precompiles::{
        ...
        B20PolicyType, B20TokenRole, BasePrecompileError, IB20, IB20Asset, PackedPolicy,
        PermitArgs, PolicyAccounting, PolicyRegistryStorage, PolicyVersion, Result, Token,
        TokenAccounting, TransferPolicyIds,
    };
