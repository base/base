...
use crate::core_precompiles::{
    Asset, AssetAccounting, AssetV1, AssetV2, B20Abi, BasePrecompileError, IB20, IB20Asset,
    IB20AssetV1, IB20AssetV2, PolicyAccounting, Result,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        AssetAbi, AssetVersion, AssetVersions, B20Abi, BasePrecompileError, IB20, IB20Asset,
        IB20AssetV1, IB20AssetV2,
    };
