...
use crate::core_precompiles::{
    B20CoreStorage, Handler, Mapping, Result, StorageCtx, StorageOps, Word,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        AssetAccounting, B20CoreStorage, B20PolicyType, B20TokenRole, Handler, StorableType,
        StorageCtx, StorageKey, TokenAccounting, TransferPolicyIds, setup_storage,
    };
