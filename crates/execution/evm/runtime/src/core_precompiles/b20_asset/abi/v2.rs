...
//! [`crate::core_precompiles::IB20`] defined in `common/abi.rs`. Being canonical, this module also owns the
...
mod tests {
    ...
    use crate::core_precompiles::{AbiFingerprint, IB20, IB20AssetV1};
