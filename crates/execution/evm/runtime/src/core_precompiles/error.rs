...
use crate::{
    JournalLoadError,
    core_precompiles::neutral::{
        PrecompileError, PrecompileHalt, PrecompileOutput, PrecompileResult,
    },
};
...
impl From<JournalLoadError<crate::ErasedError>> for BasePrecompileError {
    fn from(value: JournalLoadError<crate::ErasedError>) -> Self {
        match value {
