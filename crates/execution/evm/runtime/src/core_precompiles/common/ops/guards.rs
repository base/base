...
use crate::core_precompiles::{
    B20PausableFeature, B20PolicyType, B20TokenRole, BasePrecompileError, IB20, Result, Token,
    TokenAccounting,
};
...
impl B20Guards {
    ...
    /// via [`TokenAccounting::transfer_policy_ids`](crate::core_precompiles::TokenAccounting::transfer_policy_ids)),
...
mod tests {
    ...
    use crate::core_precompiles::{
        B20Guards, B20PolicyType, BasePrecompileError, FakePolicyAccounting, IB20,
        InMemoryTokenAccounting, PolicyRegistryStorage, PolicyVersion, TestStablecoinToken,
    };
