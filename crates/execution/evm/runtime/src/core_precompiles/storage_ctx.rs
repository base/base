...
#[cfg(any(test, feature = "test-utils"))]
use crate::core_precompiles::hashmap::HashMapStorageProvider;
...
mod tests {
    ...
    fn test_reentrant_with_storage_panics() {
        let mut storage = crate::core_precompiles::hashmap::HashMapStorageProvider::new(1);
