...
use crate::{
    CallInputs, ContextTr, CryptoPrecompileResult as PrecompileResult, InterpreterResult,
    PrecompileFn, PrecompileId, Precompiles,
    core_precompiles::{
        EthPrecompiles, EvmInternals, PrecompileProvider, precompile_output_to_interpreter_result,
    },
};
...
impl<CTX: ContextTr> PrecompileProvider<CTX> for PrecompilesMap {
    ...
    fn set_spec(&mut self, _spec: <CTX::Cfg as crate::Cfg>::Spec) -> bool {
        false
    }
...
pub trait Precompile {
    ...
    ///
    /// [`PrecompileOutput::status`]: crate::CryptoPrecompileOutput::status
...
impl Precompile for crate::CryptoPrecompile {
    fn precompile_id(&self) -> &PrecompileId {
        self.id()
    }
...
mod tests {
    ...
    fn test_supports_caching() {
        ...
        let identity = crate::identity::FUN;
