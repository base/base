...
use crate::core_precompiles::{
    B20CoreStorage, BasePrecompileError, Handler, IB20Factory, Result, StorageCtx,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        B20CoreStorage, B20StablecoinExtensionStorage, B20StablecoinStorage, Handler, StorableType,
        StorageCtx,
