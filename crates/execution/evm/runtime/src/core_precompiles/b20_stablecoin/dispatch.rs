...
use crate::core_precompiles::{
    B20PolicyType, B20StablecoinToken, B20TokenRole, B20Variant, BasePrecompileError, IB20,
    IB20::IB20Calls as C, IB20Stablecoin, IB20Stablecoin::IB20StablecoinCalls as SC,
    NoopPrecompileCallObserver, PermitArgs, PolicyAccounting, PrecompileCallObserver,
    PrecompileCallRecorder, PrecompileMetricLabels, PrecompileResult, PrecompileSelector,
    StablecoinAccounting, StablecoinVersion, StablecoinVersions, StorageCtx,
};
...
impl<S: StablecoinAccounting, A: PolicyAccounting> B20StablecoinToken<S, A> {
    ...
    /// authorized [`Stablecoin::grant_role`](crate::core_precompiles::Stablecoin) path is not yet reachable.
...
mod tests {
    ...
    use crate::core_precompiles::{
        B20StablecoinToken, FakePolicyAccounting, HashMapStorageProvider, IB20,
        InMemoryTokenAccounting, NoopPrecompileCallObserver, PolicyVersion, StablecoinVersion,
        StorageCtx, TestStablecoinToken,
    };
