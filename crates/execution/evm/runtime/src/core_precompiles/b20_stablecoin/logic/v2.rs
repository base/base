//! Version 2 of the stablecoin B-20 precompile logic, activated at Cobalt.
...
use crate::core_precompiles::{
    ...
    B20TokenRole, BasePrecompileError, Eip712Domain, IB20, NonZeroAddress, PermitArgs,
    PolicyAccounting, Result, Stablecoin, StablecoinAccounting, Token, TransferPolicyIds,
};
...
/// Second stablecoin B-20 implementation. Activated at Cobalt, behavior-identical to V1 (scaffold seam
/// for future changes).
...
impl<S: StablecoinAccounting, A: PolicyAccounting> Stablecoin<S, A> for StablecoinV2 {
    fn transfer(
        &self,
        token: &mut B20StablecoinToken<S, A>,
        caller: Address,
...
mod tests {
    ...
    use crate::core_precompiles::{
        B20_MAX_SUPPLY_CAP, B20PolicyType, B20StablecoinToken, B20TokenRole, BasePrecompileError,
        IB20, PackedPolicy, PermitArgs, PolicyAccounting, PolicyRegistryStorage, PolicyVersion,
        Result, Stablecoin, StablecoinAccounting, StablecoinV2, Token, TokenAccounting,
        TransferPolicyIds,
    };
