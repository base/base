...
use crate::core_precompiles::{
    PolicyAccounting, PolicyRegistryLogic, PolicyVersion, StablecoinAccounting, Token,
};
...
/// implementations resolved from [`crate::core_precompiles::StablecoinVersions`]. Authorization goes
/// through [`crate::core_precompiles::PolicyRegistryLogic`] via [`Token::policy`].
#[derive(Debug, Clone)]
