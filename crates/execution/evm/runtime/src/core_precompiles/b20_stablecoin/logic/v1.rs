...
use crate::core_precompiles::{
    ...
    B20TokenRole, BasePrecompileError, Eip712Domain, IB20, PermitArgs, PolicyAccounting, Result,
    Stablecoin, StablecoinAccounting, Token,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        ...
        Result, Stablecoin, StablecoinAccounting, StablecoinV1, Token, TokenAccounting,
        TransferPolicyIds,
    };
