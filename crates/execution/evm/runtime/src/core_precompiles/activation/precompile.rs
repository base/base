...
use crate::core_precompiles::{
    ActivationAdminConfig, ActivationRegistryStorage, DynPrecompile, NoopPrecompileCallObserver,
    PrecompileCallObserver, PrecompilesMap, UpgradeGatedStorageFeatures, macros::base_precompile,
};
...
mod tests {
    ...
    use crate::{
        Precompiles,
        core_precompiles::{ActivationRegistry, ActivationRegistryStorage, PrecompilesMap},
    };
