...
use crate::core_precompiles::{
    ActivationAdminConfig, ActivationRegistryStorage, BasePrecompileError, IActivationRegistry,
    IActivationRegistry::IActivationRegistryCalls as C, NoopPrecompileCallObserver,
    PrecompileCallObserver, PrecompileCallRecorder, PrecompileMetricLabels, PrecompileResult,
    StorageCtx, macros::decode_precompile_call,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        ActivationAdminConfig, ActivationRegistryStorage, HashMapStorageProvider,
        IActivationRegistry, StorageCtx,
    };
