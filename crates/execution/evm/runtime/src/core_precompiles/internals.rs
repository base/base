...
/// Dyn-compatible wrapper around [`crate::Transaction`].
///
/// [`crate::Transaction`] is not dyn-compatible because of methods returning
...
{
    fn tx_type(&self) -> u8 {
        crate::Transaction::tx_type(self)
    }

    fn caller(&self) -> Address {
        crate::Transaction::caller(self)
    }

    fn gas_limit(&self) -> u64 {
        crate::Transaction::gas_limit(self)
    }

    fn value(&self) -> U256 {
        crate::Transaction::value(self)
    }

    fn input(&self) -> &Bytes {
        crate::Transaction::input(self)
    }

    fn nonce(&self) -> u64 {
        crate::Transaction::nonce(self)
    }

    fn kind(&self) -> TxKind {
        crate::Transaction::kind(self)
    }

    fn chain_id(&self) -> Option<u64> {
        crate::Transaction::chain_id(self)
    }

    fn gas_price(&self) -> u128 {
        crate::Transaction::gas_price(self)
    }

    fn blob_versioned_hashes(&self) -> &[B256] {
        crate::Transaction::blob_versioned_hashes(self)
    }

    fn max_fee_per_blob_gas(&self) -> u128 {
        crate::Transaction::max_fee_per_blob_gas(self)
    }

    fn total_blob_gas(&self) -> u64 {
        crate::Transaction::total_blob_gas(self)
    }

    fn calc_max_data_fee(&self) -> U256 {
        crate::Transaction::calc_max_data_fee(self)
    }

    fn authorization_list_len(&self) -> usize {
        crate::Transaction::authorization_list_len(self)
    }

    fn max_fee_per_gas(&self) -> u128 {
        crate::Transaction::max_fee_per_gas(self)
    }

    fn max_priority_fee_per_gas(&self) -> Option<u128> {
        crate::Transaction::max_priority_fee_per_gas(self)
    }

    fn effective_gas_price(&self, base_fee: u128) -> u128 {
        crate::Transaction::effective_gas_price(self, base_fee)
    }

    fn max_balance_spending(&self) -> Result<U256, InvalidTransaction> {
        crate::Transaction::max_balance_spending(self)
    }
    ...
    fn effective_balance_spending(
        ...
        crate::Transaction::effective_balance_spending(self, base_fee, blob_price)
    }
}
...
impl<T> crate::Database for EvmInternalsImpl<'_, T>
where
