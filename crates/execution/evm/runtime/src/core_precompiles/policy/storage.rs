...
use crate::core_precompiles::{Handler, Mapping, PolicyAccounting, Result};
...
impl PolicyRegistryStorage<'_> {
    ...
    /// encoding is owned by the frozen [`crate::core_precompiles::PolicyRegistryV1`] logic and re-exported
    /// here for the registry's public API.
    pub const ALWAYS_ALLOW_ID: u64 = crate::core_precompiles::PolicyRegistryV1::ALWAYS_ALLOW_ID;

    /// Built-in policy ID that always rejects every account.
    ///
    /// A stable protocol sentinel; encoding owned by [`crate::core_precompiles::PolicyRegistryV1`].
    pub const ALWAYS_BLOCK_ID: u64 = crate::core_precompiles::PolicyRegistryV1::ALWAYS_BLOCK_ID;
}
...
mod tests {
    ...
    use crate::{
        Bytecode,
        core_precompiles::{
            BasePrecompileError, HashMapStorageProvider,
            IPolicyRegistry::PolicyType,
            PolicyAccounting, PolicyRegistryLogic, PolicyRegistryV1, PrecompileStorageProvider,
