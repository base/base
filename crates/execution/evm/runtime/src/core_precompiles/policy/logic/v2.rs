...
use crate::core_precompiles::{
    BasePrecompileError, IPolicyRegistry, IPolicyRegistry::PolicyType, PackedPolicy,
    PolicyAccounting, PolicyRegistryLogic, Result,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        BasePrecompileError, IPolicyRegistry, IPolicyRegistry::PolicyType, PolicyAccounting,
        PolicyRegistryLogic, PolicyRegistryV2, Result,
    };
