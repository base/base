...
use crate::core_precompiles::{
    IPolicyRegistry::PolicyType, PolicyAccounting, Result, macros::reject_frozen_selector,
};

/// The policy-registry logic interface.
///
/// Each method takes the [`PolicyAccounting`] storage port directly. Versioned
/// implementations are resolved via [`crate::core_precompiles::PolicyVersions`].
