...
use crate::core_precompiles::{
    ActivationFeature, ActivationRegistryStorage, BasePrecompileError, IPolicyRegistry,
    IPolicyRegistry::IPolicyRegistryCalls as C, NoopPrecompileCallObserver, PolicyRegistryStorage,
    PolicyRegistryV2, PolicyVersion, PolicyVersions, PrecompileAuxiliaryMetrics,
    PrecompileCallObserver, PrecompileCallRecorder, PrecompileMetricLabels, PrecompileResult,
    StorageCtx,
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        ActivationAdminConfig, ActivationFeature, ActivationRegistryStorage,
        HashMapStorageProvider, IPolicyRegistry, PolicyRegistryStorage, PolicyRegistryV1,
        PrecompileCallMetric, PrecompileCallObserver, PrecompileCallOutcome, PrecompileCallStatus,
        PrecompileErrorKind, PrecompileOutput, StorageCtx,
    };
