...
use base_execution_evm_runtime as precompile;

use crate::{
    OnceLock, Precompiles, bn254,
    core_precompiles::{
        ActivationAdminConfig, ActivationRegistry, B20Factory, BerylLookup, NonceManager,
        NoopPrecompileCallObserver, PolicyRegistryPrecompile, PrecompileCallObserver,
        PrecompilesMap, StorageFeatures, TxContext, UpgradeGatedStorageFeatures, bls12_381,
        bn254_pair,
    },
    modexp, secp256r1,
};
...
/// [`crate::core_precompiles::PrecompileProvider`]. Call [`Self::install`] or
...
mod tests {
    ...
    use crate::{
        Precompiles, bls12_381_const, bn254,
        core_precompiles::{
            ActivationRegistryStorage, B20FactoryStorage, B20Variant, BasePrecompiles,
            NonceManagerStorage, PolicyRegistryStorage, StorageFeatures, TxContextStorage,
            bls12_381, bn254_pair,
        },
        eip7823, modexp, secp256r1,
    };
