...
use crate::core_precompiles::{
    AccountConfigurationStorage, ActorConfig, ContractStorage, Result as StorageResult, StorageCtx,
};
...
impl AccountConfigurationEvents {
    ...
    /// call sites — [`crate::core_precompiles::DelegationEffect::install`] and auto-delegation —
