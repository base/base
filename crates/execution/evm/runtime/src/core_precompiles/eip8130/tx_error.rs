...
use crate::core_precompiles::{ApplyError, AuthorizeError, Operation};
...
pub enum TxAuthError {
    ...
    /// [`crate::core_precompiles::AccountChangeApplier`]. Mirrors `Keystore.AccountIsLocked`.
    ...
    /// [`crate::core_precompiles::AccountChangeApplier`]-applied `IncrementLocalEpoch` advances the
