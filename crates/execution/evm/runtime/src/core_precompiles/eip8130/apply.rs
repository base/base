...
//!
//! [`ConfigChangeAuthorizer`]: crate::core_precompiles::ConfigChangeAuthorizer
//! [`SignedChange`]: base_common_types_chain::SignedChange
//! [`AccountConfigurationEvents`]: crate::core_precompiles::AccountConfigurationEvents
...
use crate::core_precompiles::{
    ...
    BasePrecompileError, Bytecode, StorageCtx,
};
...
impl AccountChangeApplier {
    ...
    /// (see [`crate::core_precompiles::IntrinsicGasInput::revoke_discount_slots`]):
    ///
...
mod tests {
    ...
    use super::*;
    use crate::core_precompiles::{
        AccountCreated, ActorAuthorized, ActorRevoked, Bytecode, DelegationApplied,
        HashMapStorageProvider, PrecompileStorageProvider, StorageCtx,
    };
