...
use crate::core_precompiles::AuthError;
...
///
/// [`ActorAuthorizer::authorize_k1`]: crate::core_precompiles::ActorAuthorizer::authorize_k1
...
impl RecoveredActorId {
    ...
    ///
    /// [`AuthenticatorDispatch`]: crate::core_precompiles::AuthenticatorDispatch
