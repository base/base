...
pub struct AppliedTransaction {
    ...
    /// (see [`crate::core_precompiles::IntrinsicGasInput::revoke_discount_slots`]). Threaded into
...
impl TransactionAuthorizer {
    ...
    ///
    /// [`DelegationEffect::can_replace_code`]: crate::core_precompiles::DelegationEffect::can_replace_code
    /// [`DelegationEffect::install`]: crate::core_precompiles::DelegationEffect::install
    /// [`ApplyError::NonDelegatableCode`]: crate::core_precompiles::ApplyError::NonDelegatableCode
...
mod tests {
    ...
    use crate::core_precompiles::{Handler, HashMapStorageProvider, StorageCtx};
