...
pub struct MappingHandler<'a, K, V: StorableType> {
    base_slot: U256,
    address: Address,
    storage: crate::core_precompiles::StorageCtx<'a>,
...
mod tests {
    ...
    fn test_mapping_basic_properties() {
        ...
        let (mut storage, _) = crate::core_precompiles::hashmap::setup_storage();
        crate::core_precompiles::StorageCtx::enter(&mut storage, |ctx| {
