...
mod tests {
    ...
    use super::*;
    use crate::core_precompiles::{StorageKey, hashmap::setup_storage};
    ...
    #[test]
    fn test_slot_read_write_types() -> crate::core_precompiles::error::Result<()> {
    ...
    #[test]
    fn test_transient_persistence_isolation() -> crate::core_precompiles::error::Result<()> {
        let (mut storage, address) = setup_storage();
        let slot_num = U256::from(7u64);
        let t_value = U256::from(100u64);
        let s_value = U256::from(200u64);

        StorageCtx::enter(&mut storage, |ctx| -> crate::core_precompiles::error::Result<()> {
    ...
    #[test]
    fn test_slot_at_offset() -> crate::core_precompiles::error::Result<()> {
        let (mut storage, address) = setup_storage();
        StorageCtx::enter(&mut storage, |ctx| {
