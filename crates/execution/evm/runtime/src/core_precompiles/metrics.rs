...
use crate::core_precompiles::{
    BasePrecompileError, IActivationRegistry, IB20, IB20Asset, IB20Factory, IB20Stablecoin,
    IPolicyRegistry, PrecompileError, PrecompileOutput, PrecompileResult, Result, StorageCtx,
};
...
where
    O: crate::core_precompiles::PrecompileCallObserver,
{
...
mod tests {
    ...
    use crate::core_precompiles::{
        BasePrecompileError, CALLDATA_WORD_GAS, IActivationRegistry, IB20, IB20Asset, IB20Factory,
        IPolicyRegistry, NoopPrecompileCallObserver, PrecompileCallRecorder, PrecompileCallStatus,
        PrecompileError, PrecompileErrorKind, PrecompileMetricLabels, PrecompileOutput,
        PrecompileSelector,
    };
