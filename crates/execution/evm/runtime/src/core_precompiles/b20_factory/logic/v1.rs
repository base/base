...
use crate::{
    ...
    core_precompiles::{
        ...
        B20FactoryStorage, B20StablecoinInit, B20StablecoinStorage, B20StablecoinToken,
        B20TokenRole, B20Variant, BasePrecompileError, ContractStorage, Factory, IB20Factory,
        NoopPrecompileCallObserver, PolicyRegistryStorage, PolicyVersions, Result,
        StablecoinVersions, Token,
    },
};
...
mod tests {
    ...
    use crate::core_precompiles::{
        ...
        B20FactoryStorage, B20TokenRole, B20Variant, Handler, HashMapStorageProvider, IB20,
        IB20Factory, PolicyRegistryStorage, PolicyVersion, StorageCtx, Token, TokenAccounting,
    };
