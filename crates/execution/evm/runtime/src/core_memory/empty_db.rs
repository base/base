...
use crate::{
    ...
    core_memory::{AccountInfo, Bytecode, DBErrorMarker, Database, DatabaseRef},
    keccak256,
};
...
mod tests {
    ...
    fn conform_block_hash_calculation() {
        ...
        assert_eq!(
            ...
            Ok(b256!("0x044852b2a670ade5407e78fb2863c51de9fcb96542a07186fe3aeda6bb8a116d"))
        );

        assert_eq!(
            db.block_hash_ref(1u64),
            Ok(b256!("0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6"))
        );

        assert_eq!(
            db.block_hash_ref(100u64),
            Ok(b256!("0x8c18210df0d9514f2d2e5d8ca7c100978219ee80d3968ad850ab5ead208287b3"))
        );
    }
}
