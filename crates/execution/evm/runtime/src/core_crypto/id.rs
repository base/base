...
use crate::core_crypto::{Precompile, PrecompileSpecId};
...
impl PrecompileId {
    ...
    pub fn precompile(&self, spec: PrecompileSpecId) -> Option<Precompile> {
        ...
        let precompile = match self {
            Self::EcRec => crate::core_crypto::secp256k1::ECRECOVER,
            Self::Sha256 => crate::core_crypto::hash::SHA256,
            Self::Ripemd160 => crate::core_crypto::hash::RIPEMD160,
            Self::Identity => crate::core_crypto::identity::FUN,
            Self::ModExp => {
                // ModExp changes gas calculation based on spec
                if spec < BERLIN {
                    crate::core_crypto::modexp::BYZANTIUM
                } else if spec < OSAKA {
                    crate::core_crypto::modexp::BERLIN
                } else {
                    crate::core_crypto::modexp::OSAKA
                }
            }
            Self::Bn254Add => {
                // BN254 add - gas cost changes in Istanbul
                if spec < ISTANBUL {
                    crate::core_crypto::bn254::add::BYZANTIUM
                } else {
                    crate::core_crypto::bn254::add::ISTANBUL
                }
            }
            Self::Bn254Mul => {
                // BN254 mul - gas cost changes in Istanbul
                if spec < ISTANBUL {
                    crate::core_crypto::bn254::mul::BYZANTIUM
                } else {
                    crate::core_crypto::bn254::mul::ISTANBUL
                }
            }
            Self::Bn254Pairing => {
                // BN254 pairing - gas cost changes in Istanbul
                if spec < ISTANBUL {
                    crate::core_crypto::bn254::pair::BYZANTIUM
                } else {
                    crate::core_crypto::bn254::pair::ISTANBUL
                }
            }
            Self::Blake2F => crate::core_crypto::blake2::FUN,
            Self::KzgPointEvaluation => crate::core_crypto::kzg_point_evaluation::POINT_EVALUATION,
            Self::Bls12G1Add => crate::core_crypto::bls12_381::g1_add::PRECOMPILE,
            Self::Bls12G1Msm => crate::core_crypto::bls12_381::g1_msm::PRECOMPILE,
            Self::Bls12G2Add => crate::core_crypto::bls12_381::g2_add::PRECOMPILE,
            Self::Bls12G2Msm => crate::core_crypto::bls12_381::g2_msm::PRECOMPILE,
            Self::Bls12Pairing => crate::core_crypto::bls12_381::pairing::PRECOMPILE,
            Self::Bls12MapFpToGp1 => crate::core_crypto::bls12_381::map_fp_to_g1::PRECOMPILE,
            Self::Bls12MapFp2ToGp2 => crate::core_crypto::bls12_381::map_fp2_to_g2::PRECOMPILE,
            Self::P256Verify => {
                // P256 verify - gas cost changes in Osaka
                if spec < OSAKA {
                    crate::core_crypto::secp256r1::P256VERIFY
                } else {
                    crate::core_crypto::secp256r1::P256VERIFY_OSAKA
                }
            }
