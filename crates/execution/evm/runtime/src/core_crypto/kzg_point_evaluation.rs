...
pub const ADDRESS: Address = crate::core_crypto::u64_to_address(0x0A);
...
mod tests {
    ...
    fn basic_test() {
        ...
        let crypto = &crate::core_crypto::DefaultCrypto;
        let mut versioned_hash = crate::core_crypto::Crypto::sha256(crypto, &commitment).to_vec();
