//! bitcoin_secp256k1 implementation of `ecrecover`. More about it in [`crate::core_crypto::secp256k1`].
...
use crate::{B256, alloy_primitives::B512, keccak256};
...
pub fn ecrecover(sig: &B512, recid: u8, msg: &B256) -> Result<B256, secp256k1_0_31_1::Error> {
