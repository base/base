...
pub use arkworks as crypto_backend;
...
pub mod add {
    ...
    pub const ADDRESS: Address = crate::core_crypto::u64_to_address(6);
...
pub mod mul {
    ...
    pub const ADDRESS: Address = crate::core_crypto::u64_to_address(7);
...
pub mod pair {
    ...
    pub const ADDRESS: Address = crate::core_crypto::u64_to_address(8);
