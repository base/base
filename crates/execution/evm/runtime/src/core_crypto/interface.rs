...
use crate::{
    AnyError, Bytes, GasTracker, OnceLock,
    core_crypto::bls12_381::{G1Point, G1PointScalar, G2Point, G2PointScalar},
};
...
pub trait Crypto: Send + Sync + Debug {
    ...
    fn bn254_g1_add(&self, p1: &[u8], p2: &[u8]) -> Result<[u8; 64], PrecompileHalt> {
        crate::core_crypto::bn254::crypto_backend::g1_point_add(p1, p2)
    }

    /// BN254 elliptic curve scalar multiplication.
    #[inline]
    fn bn254_g1_mul(&self, point: &[u8], scalar: &[u8]) -> Result<[u8; 64], PrecompileHalt> {
        crate::core_crypto::bn254::crypto_backend::g1_point_mul(point, scalar)
    }

    /// BN254 pairing check.
    #[inline]
    fn bn254_pairing_check(&self, pairs: &[(&[u8], &[u8])]) -> Result<bool, PrecompileHalt> {
        crate::core_crypto::bn254::crypto_backend::pairing_check(pairs)
    }
    ...
    fn secp256k1_ecrecover(
        ...
        crate::core_crypto::secp256k1::ecrecover_bytes(sig, recid, msg)
    ...
    fn modexp(&self, base: &[u8], exp: &[u8], modulus: &[u8]) -> Result<Vec<u8>, PrecompileHalt> {
        Ok(crate::core_crypto::modexp::modexp(base, exp, modulus))
    }

    /// Blake2 compression function.
    #[inline]
    fn blake2_compress(&self, rounds: u32, h: &mut [u64; 8], m: &[u64; 16], t: &[u64; 2], f: bool) {
        crate::core_crypto::blake2::compress(rounds, h, m, t, f);
    }

    /// secp256r1 (P-256) signature verification.
    #[inline]
    fn secp256r1_verify_signature(&self, msg: &[u8; 32], sig: &[u8; 64], pk: &[u8; 64]) -> bool {
        crate::core_crypto::secp256r1::verify_signature(msg, sig, pk).is_some()
    }
    ...
    fn verify_kzg_proof(
        ...
        if !crate::core_crypto::kzg_point_evaluation::verify_kzg_proof(commitment, z, y, proof) {
    ...
    fn bls12_381_g1_add(&self, a: G1Point, b: G1Point) -> Result<[u8; 96], PrecompileHalt> {
        crate::core_crypto::bls12_381::crypto_backend::p1_add_affine_bytes(a, b)
    }
    ...
    fn bls12_381_g1_msm(
        ...
        crate::core_crypto::bls12_381::crypto_backend::p1_msm_bytes(pairs)
    }
    ...
    fn bls12_381_g2_add(&self, a: G2Point, b: G2Point) -> Result<[u8; 192], PrecompileHalt> {
        crate::core_crypto::bls12_381::crypto_backend::p2_add_affine_bytes(a, b)
    }
    ...
    fn bls12_381_g2_msm(
        ...
        crate::core_crypto::bls12_381::crypto_backend::p2_msm_bytes(pairs)
    }
    ...
    fn bls12_381_pairing_check(
        ...
        crate::core_crypto::bls12_381::crypto_backend::pairing_check_bytes(pairs)
    }

    /// BLS12-381 map field element to G1.
    fn bls12_381_fp_to_g1(&self, fp: &[u8; 48]) -> Result<[u8; 96], PrecompileHalt> {
        crate::core_crypto::bls12_381::crypto_backend::map_fp_to_g1_bytes(fp)
    }

    /// BLS12-381 map field element to G2.
    fn bls12_381_fp2_to_g2(&self, fp2: ([u8; 48], [u8; 48])) -> Result<[u8; 192], PrecompileHalt> {
        crate::core_crypto::bls12_381::crypto_backend::map_fp2_to_g2_bytes(&fp2.0, &fp2.1)
    }
}
...
macro_rules! eth_precompile_fn {
    ($name:ident, $eth_fn:expr) => {
        fn $name(input: &[u8], gas_limit: u64, reservoir: u64) -> $crate::CryptoPrecompileResult {
