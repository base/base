...
//!    --test core_precompiles_b20_stablecoin_v2_golden -- --nocapture` and copy the printed `GOLDEN_ROOT` values.
...
use base_execution_evm_runtime::{
    ...
    B20TokenRole, BasePrecompileError, FakePolicyAccounting, HashMapStorageProvider, IB20,
    IB20Stablecoin, NoopPrecompileCallObserver, PolicyVersion, Stablecoin, StablecoinV2,
    StablecoinVersion, StablecoinVersions, StorageCtx, TokenAccounting,
