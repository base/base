...
//! `BLESS_GOLDEN=1 cargo test -p base-execution-evm-runtime --features test-utils \
//!    --test core_precompiles_b20_asset_v1_golden -- --nocapture` and copy the printed `GOLDEN_ROOT` values.
...
use base_execution_evm_runtime::{
    ...
    B20AssetStorage, B20AssetToken, B20PolicyType, B20TokenRole, BasePrecompileError,
    FakePolicyAccounting, HashMapStorageProvider, IB20, IB20Asset, NoopPrecompileCallObserver,
    PolicyVersion, StorageCtx, StorageHandler, TokenAccounting, UpgradeGatedStorageFeatures,
};
