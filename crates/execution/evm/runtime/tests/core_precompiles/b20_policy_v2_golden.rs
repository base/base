...
//!    --test core_precompiles_b20_policy_v2_golden -- --nocapture` and copy the printed `GOLDEN_ROOT` values.
...
use base_execution_evm_runtime::{
    ...
    IPolicyRegistry, PolicyRegistryStorage, PolicyVersion, PolicyVersions, StorageCtx,
