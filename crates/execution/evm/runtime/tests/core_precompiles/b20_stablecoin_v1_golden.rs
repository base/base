...
//!    --test core_precompiles_b20_stablecoin_v1_golden -- --nocapture` and copy the printed `GOLDEN_ROOT` values.
...
use base_execution_evm_runtime::{
    ...
    IB20Stablecoin, NoopPrecompileCallObserver, PolicyVersion, Stablecoin, StablecoinV1,
