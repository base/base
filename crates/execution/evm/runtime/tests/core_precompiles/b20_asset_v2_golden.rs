...
//!    --test core_precompiles_b20_asset_v2_golden -- --nocapture` and copy the printed `GOLDEN_ROOT` values.
...
use base_execution_evm_runtime::{
    ...
    ERC165_INTERFACE_ID, ERC8056_INTERFACE_IDS, FakePolicyAccounting, HashMapStorageProvider, IB20,
    IB20Asset, NoopPrecompileCallObserver, PolicyVersion, StorageCtx, StorageHandler,
