...
///
/// By default this expands through `crate::core_precompiles::macros::base_precompile!` in the invoking crate. Callers
/// outside `base-execution-evm-runtime` can pass `macro_path = path::to::wrapper_macro` to override the
