...
use base_execution_evm_precompiles::{BasePrecompileError, Handler, Mapping, PrecompileResult, Result};
...
impl ActivationRegistryStorage<'_> {
    ...
    /// [`base_execution_evm_precompiles::PrecompileOutput::is_revert`] to distinguish an activated feature from an
    /// ABI revert.
