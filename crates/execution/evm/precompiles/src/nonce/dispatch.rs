...
impl NonceManagerStorage<'_> {
    ...
    fn inner(&self, calldata: &[u8]) -> base_execution_evm_precompiles::Result<Bytes> {
...
mod tests {
    ...
    fn dispatch(
        ...
        calldata: &[u8],
    ) -> base_execution_evm_precompiles::PrecompileOutput {
    ...
    fn gas_matches_evm_reference() {
        assert_eq!(super::CALLDATA_WORD_GAS, base_execution_evm_machine::gas::KECCAK256WORD);
    }
