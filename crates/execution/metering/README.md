...
- EIP-8130 intrinsic components: `INTRINSIC_AA_BASE_COST`,
  `INTRINSIC_TX_PAYLOAD_COST`, `INTRINSIC_NONCE_KEY_COST`,
  `INTRINSIC_BYTECODE_COST`, `INTRINSIC_ACCOUNT_CHANGES_COST`,
  `INTRINSIC_AUTO_DELEGATION_COST`, `INTRINSIC_SENDER_AUTH_COST`, and
  `INTRINSIC_PAYER_AUTH_COST`.
