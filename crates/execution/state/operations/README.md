# `base-execution-state-operations`
...
```toml
[dependencies]
base-execution-state-operations = { workspace = true }
```

```rust,ignore
use base_execution_state_operations::{BaseProofStoragePruner, RocksdbProofsStorage};
