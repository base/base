...
pub type BaseProofStoragePrunerResult = Result<ProofStoragePrunerOutput, ProofStoragePrunerError>;

/// Successful prune summary.
#[derive(Debug, Clone, Default, Eq, PartialEq)]
pub struct ProofStoragePrunerOutput {
...
impl Display for ProofStoragePrunerOutput {
...
impl ProofStoragePrunerOutput {
    /// extend the current [`ProofStoragePrunerOutput`] with another [`ProofStoragePrunerOutput`]
...
pub enum ProofStoragePrunerError {
...
mod tests {
    ...
    use super::ProofStoragePrunerOutput;
    use crate::api::WriteCounts;

    #[test]
    fn test_pruner_output_display() {
        let pruner_output = ProofStoragePrunerOutput {
