...
intermediate hash-builder state, persisted account and storage changes, block indices, pruning policies, pipeline checkpoints and targets, static-file metadata, and serialization helpers.
