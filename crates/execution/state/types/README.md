...
consumers. Memory state is provided by `base-execution-evm-runtime`; provider and database
...
Provider interfaces are defined here alongside their data types. Database transaction traits,
statistics interfaces, and the noop database adapter live in `base-execution-state-database`.
