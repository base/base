//! Pipeline targets, stage identifiers, checkpoints, and execution thresholds.
...
pub use checkpoints::{
    ...
    FinishCheckpoint, HeadersCheckpoint, IndexHistoryCheckpoint, MerkleChangeSetsCheckpoint,
