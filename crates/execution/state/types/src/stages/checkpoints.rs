...
impl base_common_types_chain::Compact for MerkleCheckpoint {
...
#[cfg(any(test, feature = "reth-codec"))]
impl base_common_types_chain::Compact for StorageRootMerkleCheckpoint {
    fn to_compact<B>(&self, buf: &mut B) -> usize
    where
        B: bytes::BufMut + AsMut<[u8]>,
    {
...
#[cfg(any(test, feature = "reth-codec"))]
base_common_types_chain::impl_compression_for_compact!(StageCheckpoint);
