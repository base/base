...
use base_execution_evm_runtime::{BundleState, StoredBytecode as Bytecode};

use super::{
    AccountReader, BlockHashReader, BlockIdReader, StateProofProvider, StateRootProvider,
    StorageRootProvider,
};
use crate::{ExecutionOutcome, HashedPostState, ProviderResult};
...
pub trait StateReadProvider:
    ...
    + AccountReader
    + BytecodeReader
    + base_execution_evm_runtime::DatabaseRef<Error = crate::ProviderError>
{
