...
impl base_common_types_chain::Compact for StoredNibbles {
...
#[cfg(any(test, feature = "reth-codec"))]
base_common_types_chain::impl_compression_for_compact!(StoredNibbles);
...
#[cfg(any(test, feature = "reth-codec"))]
impl base_common_types_chain::Compact for StoredNibblesSubKey {
    fn to_compact<B>(&self, buf: &mut B) -> usize
    where
        B: bytes::BufMut + AsMut<[u8]>,
    {
...
#[cfg(any(test, feature = "reth-codec"))]
base_common_types_chain::impl_compression_for_compact!(StoredNibblesSubKey);
...
#[cfg(any(test, feature = "reth-codec"))]
impl base_common_types_chain::Compact for PackedStoredNibbles {
    fn to_compact<B>(&self, buf: &mut B) -> usize
    where
        B: bytes::BufMut + AsMut<[u8]>,
    {
...
#[cfg(any(test, feature = "reth-codec"))]
base_common_types_chain::impl_compression_for_compact!(PackedStoredNibbles);
...
#[cfg(any(test, feature = "reth-codec"))]
impl base_common_types_chain::Compact for PackedStoredNibblesSubKey {
    fn to_compact<B>(&self, buf: &mut B) -> usize
    where
        B: bytes::BufMut + AsMut<[u8]>,
    {
...
#[cfg(any(test, feature = "reth-codec"))]
base_common_types_chain::impl_compression_for_compact!(PackedStoredNibblesSubKey);
