...
use base_execution_txpool::{
    TransactionPool, TransactionValidity, ValidatedTransaction, ValidityOperator, ValidityPredicate,
};
use jsonrpsee::core::RpcResult;

use crate::{
    BuilderApiImpl, BuilderApiServer,
    txpool::{BuilderApiConfig, ValidityMetrics},
};
...
impl ShadowValidityConfig {
    ...
    fn inject(&self, tx: &mut ValidatedTransaction) -> InjectionOutcome {
        if !self.enabled {
...
mod tests {
    ...
    fn transaction(raw: Bytes) -> ValidatedTransaction {
