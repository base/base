...
use crate::{
    BaseEthApi, BaseEthApiError, BaseInvalidTransactionError, EthApiError, SequencerClient,
    SignersForRpc, TransactionSource, block::convert_transaction_receipt,
};
...
impl BaseEthApi {
    pub async fn transaction_by_hash(
        &self,
        hash: B256,
    ) -> Result<Option<TransactionSource>, BaseEthApiError> {
