...
use base_common_types_chain::{BaseReceipt, BlockHeader, IndexedTx, RecoveredBlock, SealedHeader};
use base_common_types_rpc::BaseTransactionReceipt;
use base_execution_state_provider::BlockState;
...
pub enum PendingBlockEnvOrigin {
    ...
    ActualPending(Arc<RecoveredBlock>, Arc<Vec<BaseReceipt>>),
