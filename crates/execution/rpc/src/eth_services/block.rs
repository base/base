...
use base_common_types_chain::{
    BaseReceipt, BlockBodyExt as BlockBody, BlockHeader, IndexedTx, Recovered, RecoveredBlock,
    SealedBlock, TxReceipt, transaction::TransactionMeta,
};
use base_common_types_rpc::BaseTransactionReceipt;

use crate::{
    ConvertReceiptInput,
    eth_services::{TransactionSource, utils::calculate_gas_used_and_next_log_index},
};
...
pub struct CachedTransaction {
    ...
    pub receipts: Option<Arc<Vec<BaseReceipt>>>,
}
...
impl CachedTransaction {
    ...
    pub const fn new(
        ...
        tx_index: usize,
        receipts: Option<Arc<Vec<BaseReceipt>>>,
    ) -> Self {
    ...
    pub fn to_transaction_source(&self) -> Option<TransactionSource> {
    ...
    pub fn receipt(&self) -> Option<&BaseReceipt> {
...
impl BlockAndReceipts {
    ...
    /// the rpc format.
    pub fn find_and_convert_transaction_receipt(
        &self,
        tx_hash: TxHash,
...
impl CachedTransaction {
    ...
    pub fn into_receipt(
        ...
        convert_transaction_receipt(self.block.as_ref(), receipts.as_ref(), tx, receipt, converter)
    }
}
