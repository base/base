...
use base_common_chain_config::{
    ChainSpecProvider, Upgrades, tx_estimated_size_fjord as estimate_tx_compressed_size,
};
use base_common_types_chain::{
    BaseReceipt, BaseTransaction, BaseTxEnvelope, BlockHeader, Receipt, ReceiptWithBloom,
    SealedBlock, TxReceipt,
};
...
mod tests {
    ...
    use base_common_types_chain::{
        BaseTransactionSigned, BaseTypedTransaction, Block, BlockBody, Eip658Value, Recovered,
        TxEip7702, transaction::TransactionMeta,
    };
