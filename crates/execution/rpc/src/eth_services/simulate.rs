...
use base_common_types_chain::{
    BaseTxEnvelope, BlockHeader, Recovered, RecoveredBlock, SealedHeader, Transaction as _,
};
...
use crate::{
    RpcBlockConverter, RpcErrorFactory,
    eth_services::{EthApiError, error::ToRpcError},
};
...
///
/// [`TransactionRequest`]: base_common_types_rpc::TransactionRequest
pub fn resolve_transaction<DB: Database>(
...
pub fn build_simulated_block(
    ...
    results: Vec<ExecutionResult<base_execution_evm_runtime::BaseHaltReason>>,
...
mod tests {
    ...
    use base_execution_evm_runtime::{Precompiles, PrecompilesMap};
