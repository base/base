...
use crate::{BaseEthApi, EthCapabilities, EthCapabilitiesHead, EthCapabilitiesResource, EthSigner};
...
mod tests {
    ...
    use base_execution_state_types::{ProviderResult, PruneCheckpoint};
