...
use base_execution_evm_blocks::{BlockExecutor, Evm, EvmFactoryExt, IntoTxEnv, TracingCtx};
...
impl BaseEthApi {
    /// Executes the [`base_execution_evm_runtime::BaseTransaction`] with [`base_execution_evm_blocks::EvmEnv`] against the given [`StateCacheDb`]
    ...
    where
        F: FnOnce(
            ...
            + Send
            + 'static,
        Insp: for<'a> base_execution_evm_runtime::Inspector<
                base_execution_evm_runtime::BaseContext<&'a mut StateCacheDb>,
            > + Send
            + 'static,
        R: Send + 'static,
    ...
    pub fn inspect_transaction_in_block<'a>(
        ...
        >,
        target_tx_index: usize,
        target_tx_env: impl IntoTxEnv<base_execution_evm_runtime::BaseTransaction>,
    ) -> Result<
        (
            ResultAndState<base_execution_evm_runtime::BaseHaltReason>,
    ...
    where
        ...
        Insp: Clone
            + for<'a> base_execution_evm_runtime::Inspector<
                base_execution_evm_runtime::BaseContext<&'a mut StateCacheDb>,
            >,
        R: Send + 'static,
    {
