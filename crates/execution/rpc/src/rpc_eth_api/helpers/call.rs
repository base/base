...
use base_common_types_chain::{BlockHeader, Recovered, transaction::TxHashRef};
...
use base_execution_evm_blocks::{CancelOnDrop, Evm};
use base_execution_evm_runtime::{
    Block, Cfg, Database, DatabaseCommit, EvmDatabaseError, ResultAndState, State, Transaction,
};
use base_execution_state_provider::providers::BlockchainProvider;
use base_execution_state_types::{BlockIdReader, ProviderError, ProviderTx};
use futures::Future;
use tracing::{trace, warn};

use crate::{
    BaseEthApi, BaseEthApiError, EthApiError, OverrideBlockHashes, StateCacheDb,
...
impl BaseEthApi {
    ...
    /// [`BlockingTaskPool`](base_common_runtime::pool::BlockingTaskPool).
    ...
    pub fn replay_transactions_until_with_evm<'a, DB, I, Txs>(
        &self,
        evm: &mut base_execution_evm_runtime::BaseEvm<DB, I>,
        transactions: Txs,
