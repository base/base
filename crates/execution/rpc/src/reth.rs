...
use base_execution_state_types::{
    BlockIdReader, BlockReader, CanonStateNotification, ChangeSetReader, ExecutionOutcome,
...
impl RethApi {
    ...
    pub fn provider(&self) -> &base_execution_state_provider::BlockchainProvider {
        &self.inner.provider
    }
...
#[async_trait]
impl RethApiServer for RethApi {
