...
use base_common_runtime::{Runtime, pool::BlockingTaskPool};
use base_common_types_rpc::{
    DEFAULT_ETH_PROOF_WINDOW, DEFAULT_MAX_BLOCKING_IO_REQUEST, DEFAULT_MAX_SIMULATE_BLOCKS,
    DEFAULT_PROOF_PERMITS, GasPriceOracleConfig, PendingBlockKind,
};
use base_execution_state_provider::{CanonStateSubscriptions, providers::BlockchainProvider};

use crate::{
    BaseEthApi, BaseRpcContext, BaseRpcConverter, EthStateCache, EthStateCacheConfig,
    FeeHistoryCache, FeeHistoryCacheConfig, ForwardConfig, GasCap, GasPriceOracle,
    eth_backend::core::BaseEthApiInner, fee_history::fee_history_cache_new_blocks_task,
};
...
pub struct EthApiBuilder {
    ...
    rpc_converter: BaseRpcConverter,
    gas_cap: GasCap,
