...
use base_execution_evm_runtime::{
    CallScheme, CreateScheme, InstructionResult, opcode, opcode::OpCode,
};
...
impl CallTraceNode {
    ...
    ///
    /// See `Inspector::call` impl of [TracingInspector](crate::inspectors::tracing::TracingInspector)
...
/// [JournalEntry::StorageChanged](base_execution_evm_runtime::JournalEntry::StorageChanged)
///
...
mod opcode_serde {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(OpCode::new(op)
            .unwrap_or_else(|| OpCode::new(base_execution_evm_runtime::opcode::INVALID).unwrap()))
    }
}
