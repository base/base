...
use base_execution_evm_runtime::{
    Account, DatabaseRef, ExecutionResult, HaltReasonTr, KECCAK_EMPTY, ResultAndState,
    hardfork::SpecId,
};
...
impl ParityTraceBuilder {
    ...
    /// with the [TracingInspector](crate::inspectors::tracing::TracingInspector).
...
/// walker in [crate::inspectors::tracing::builder::walker]
///
...
///
/// It's expected that `DB` is a revm [Database](base_execution_evm_runtime::Database) which at this
...
mod tests {
    use super::*;
    use crate::inspectors::tracing::types::{CallKind, CallTrace};
