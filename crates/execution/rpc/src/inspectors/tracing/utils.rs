...
use base_execution_evm_runtime::{DatabaseRef, InstructionResult, KECCAK_EMPTY, hardfork::SpecId};

use crate::inspectors::tracing::config::TraceStyle;
...
pub(crate) fn load_account_code<DB: DatabaseRef>(
    db: DB,
    db_acc: &base_execution_evm_runtime::AccountInfo,
) -> Option<Bytes> {
