...
use base_execution_evm_runtime::{
    Address, B256, Bytes, CallInput, CallInputs, CallOutcome, CallScheme, ContextTr, CreateInputs,
    CreateOutcome, Inspector, Interpreter, InterpreterResult, JournalEntry, JournalExt, JournalTr,
    LocalContextTr, Log, U256, hardfork::SpecId, opcode, opcode::OpCode,
};
...
impl TracingInspector {
    ...
    fn fill_step_on_step_end<CTX: ContextTr>(
        ...
        // TODO: Figure out why this can overflow. https://github.com/paradigmxyz/base-execution-evm-inspectors/pull/38
