...
use base_execution_evm_runtime::{
    Account, BlobExcessGasAndPrice, BlockEnv, Bytecode, BytecodeDecodeError, CacheDB, Database,
    DatabaseCommit, EvmStorageSlot, JournalAccountStatus, State, TransactionId,
};
    ...
    DB: Database + DatabaseCommit,
{
    ...
    let mut acc = base_execution_evm_runtime::Account::from(info);
...
mod tests {
    ...
    use base_execution_evm_runtime::EmptyDB;
    ...
    fn test_create2_state_diff_inspect_bug() {
        ...
        use base_execution_evm_runtime::{
            AccountInfo, Context, ContextTr, CreateInputs, CreateOutcome, EmptyDB, ExecuteEvm,
            InspectEvm, Inspector, JournalTr, MainBuilder, TxEnv, hardfork::SpecId,
        };

        type TestDb = State<CacheDB<EmptyDB>>;
        type TestCtx = base_execution_evm_runtime::ReferenceContext<
            TxEnv,
            base_execution_evm_runtime::CfgEnv,
            TestDb,
        >;
        ...
        let build_db = |with_bundle: bool| {
            ...
            cache_db.insert_account_info(
                ...
                AccountInfo {
                    ...
                    code: Some(
                        base_execution_evm_runtime::Bytecode::new_raw_checked(
                            deployer_code.clone(),
                        )
                        .unwrap(),
                    ),
        ...
        let build_db = || {
            ...
            cache_db.insert_account_info(
                ...
                AccountInfo {
                    ...
                    code: Some(
                        base_execution_evm_runtime::Bytecode::new_raw_checked(impl_bytecode)
                            .unwrap(),
                    ),
                    nonce: 1,
                    ..Default::default()
