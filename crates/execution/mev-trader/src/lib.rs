...
pub use edge_measurement::{
    ...
    BlinkRejectRecordV3, CandidatePreEnqueueDropCountersV1, CandidatePreEnqueueDropReasonV3,
    CheckedCandidateBoundsV1, EDGE_MAX_VICTIM_RAW_BYTES, EdgeCandidateDetailV1,
