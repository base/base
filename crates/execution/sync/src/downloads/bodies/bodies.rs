...
use base_common_types_chain::{BlockHeader, InMemorySize, SealedHeader};
use base_execution_evm_blocks::BaseBeaconConsensus;
use base_execution_network_service::{
    BlockResponse, BodyDownloader, BodyDownloaderResult, DownloadError, DownloadResult,
};
use base_execution_network_wire::BodiesClient;
use base_execution_state_types::HeaderProvider;
use futures::Stream;
...
use crate::{
    BodiesConfig,
    downloads::{bodies::task::BodyDownloadTask, metrics::BodyDownloaderMetrics},
};
...
pub struct BodiesDownloader<C: BodiesClient, Provider: HeaderProvider> {
    ...
    in_progress_queue: BodiesRequestQueue<C>,
    /// Buffered responses
...
mod tests {
    ...
    use base_testing_support::{
        generators,
        generators::{BlockRangeParams, random_block_range},
    };
