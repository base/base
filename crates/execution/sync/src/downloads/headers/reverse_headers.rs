...
use base_common_types_chain::{BlockHeader, GotExpected, SealedHeader};
use base_execution_evm_blocks::BaseBeaconConsensus;
use base_execution_network_service::{
    DownloadError, DownloadResult, HeaderDownloadValidation, HeaderDownloader,
    HeadersDownloaderError, HeadersDownloaderResult, SyncTarget,
};
use base_execution_network_wire::{
    HeadersClient, HeadersRequest, PeerId, PeerRequestResult, Priority,
};
...
use crate::{HeadersConfig, downloads::metrics::HeaderDownloaderMetrics};
...
pub struct ReverseHeadersDownloader<H: HeadersClient> {
    ...
    buffered_responses: BinaryHeap<OrderedHeadersResponse<base_common_types_chain::Header>>,
    ...
    H: HeadersClient + 'static,
{
    ...
    fn process_next_headers(
        &mut self,
        request: HeadersRequest,
        headers: Vec<base_common_types_chain::Header>,
        peer_id: PeerId,
    ...
    fn on_sync_target_outcome(
        &mut self,
        response: HeadersRequestOutcome<base_common_types_chain::Header>,
    ) -> Result<(), ReverseHeadersDownloaderError> {
...
mod tests {
    ...
    use base_execution_network_wire::{DownloadClient, PeerRequestResult, WithPeerId};
