...
pub fn init_logging() {
    ...
    INIT.get_or_init(|| {
        ...
        let filter = Targets::new().with_targets([
            ...
            ("sync", level),
            ("fault_proof", level),
            ("base_succinct_fp", level),
            ("base_succinct_client_utils", level),
            ("base_succinct_ethereum_host_utils", level),
            ("base_succinct_host_utils", level),
            ("base_succinct_proof_utils", level),
            ("base_succinct_signer_utils", level),
        ]);
