...
impl DaEgress {
    ...
    fn lease_blobs(
        ...
        let submission = BatchSubmission::blobs(submission_id, payloads)
            .expect("a blob lease always contains at least one artifact");
    ...
    fn commit_blob(
        ...
        let payload = BlobPayload::new(frames).expect("blob plan always contains a frame");
