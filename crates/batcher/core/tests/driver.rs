...
use base_batcher_core::{
    AdminHandle, BatchDriver, BatchDriverConfig, DaThrottle, NoopThrottleClient, ThrottleConfig,
...
fn test_pause_resets_pipeline() {
    Runner::start(Config::seeded(0), |ctx| async move {
        ...
        let driver = DriverFixture::build(ctx.clone(), pipeline, ImmediateConfirmTxManager { l1_block: 1 })
