...
| `admin_startBatcher` | Starts ingestion again from the safe L2 head. Does nothing if the batcher is already running. A stop still waiting for in-flight submissions fails. |
