//! Tests for the Base chain parser used by maintenance commands.

use crate::BaseChainSpecParser as BaseTestChainSpecParser;
...
mod tests {
    ...
    fn parse_known_chain_spec() {
        for &chain in BaseTestChainSpecParser::SUPPORTED_CHAINS {
            assert!(BaseTestChainSpecParser::parse(chain).is_ok());
        }
    }
  ...
  "config": {
    ...
    "base": { "azul": 0 }
        ...
        let spec = BaseTestChainSpecParser::parse(s).unwrap();
