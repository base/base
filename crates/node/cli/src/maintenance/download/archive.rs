...
use super::{
    ...
    extract::{CompressionFormat, extract_archive_raw, streaming_download_and_extract},
    fetch::ArchiveFetcher,
    manifest::SnapshotArchive,
    planning::{PlannedArchive, PlannedDownloads},
    progress::{
        ArchiveDownloadProgress, ArchiveExtractionProgress, ArchiveVerificationProgress,
        DownloadRequestLimiter, SharedProgress, spawn_progress_display,
    },
