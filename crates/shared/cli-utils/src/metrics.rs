...
use crate::{CliResult, PrometheusServer};
...
pub struct MetricsArgs {
    ...
    #[arg(
        ...
        env = "BASE_METRICS_ENABLED"
    )]
    pub enabled: bool,

    /// The port to serve Prometheus metrics on.
    #[arg(long = "metrics.port", global = true, default_value = "9090", env = "BASE_METRICS_PORT")]
    pub port: u16,
