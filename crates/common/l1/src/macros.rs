...
///
/// ```rust,ignore
/// base_common_l1::define_tx_manager_cli!("BASE_TX_MANAGER");
/// base_common_l1::define_tx_manager_cli!("BASE_CHALLENGER_TX_MANAGER");
/// base_common_l1::define_tx_manager_cli!(
///     "BASE_PROPOSER",
...
///
/// ```rust,ignore
/// base_common_l1::define_signer_cli!("CHALLENGER");
/// base_common_l1::define_signer_cli!("PROPOSER");
/// ```
///
...
/// `::alloy_primitives::Address`, and `::base_common_client_ethereum::PrivateKeySigner`
        ...
        impl TryFrom<SignerCli> for $crate::SignerConfig {
            ...
            fn try_from(cli: SignerCli) -> Result<Self, Self::Error> {
                match (cli.private_key, cli.signer_endpoint, cli.signer_address) {
                    (Some(pk), None, None) => {
                        let signer = pk
                            .parse::<::base_common_client_ethereum::PrivateKeySigner>()
