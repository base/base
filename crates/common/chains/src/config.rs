...
pub struct ChainConfig {
    ...
    /// Subsecond activation timestamp (optional). Phantom hardfork gating 200ms cadence
    /// and millisecond payload timestamps; held separate from Beryl so devnet can iterate
    /// on sub-second support without churning Beryl's mainnet activation.
    pub subsecond_timestamp: Option<u64>,
    ...
    pub const fn hardfork_config(&self) -> HardForkConfig {
        HardForkConfig {
            ...
            base: HardforkConfig {
                ...
                subsecond: self.subsecond_timestamp,
            },
        }
    }
