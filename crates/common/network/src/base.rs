...
use base_alloy_consensus::{BaseReceipt, BaseTxType};
...
impl Network for Base {
    ...
    type TxEnvelope = base_alloy_consensus::BaseTxEnvelope;

    type UnsignedTx = base_alloy_consensus::BaseTypedTransaction;
