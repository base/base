...
use base_common_consensus::Header as AlloyHeader;
...
///
/// Notice: Make sure this struct is 1:1 with [`base_common_consensus::Header`]
#[cfg_attr(
...
mod tests {
    ...
    use base_common_consensus::EMPTY_OMMER_ROOT_HASH;
