...
impl From<BasePooledTransaction> for base_common_consensus::transaction::PooledTransaction {
...
#[cfg(feature = "k256")]
impl base_common_consensus::transaction::SignerRecoverable for BasePooledTransaction {
    fn recover_signer(
        &self,
        ...
        base_common_consensus::crypto::secp256k1::recover_signer(self.signature(), signature_hash)
    }
