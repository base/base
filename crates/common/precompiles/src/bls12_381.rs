...
fn run_isthmus_g1_msm(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
fn run_isthmus_g2_msm(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
fn run_isthmus_pairing(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
fn run_jovian_g1_msm(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
fn run_jovian_g2_msm(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
fn run_jovian_pairing(input: &[u8], gas_limit: u64) -> PrecompileResult {
...
mod tests {
    ...
    fn test_max_size_rejects_oversized_input(
        ...
        let result = precompile.execute(&input, gas_limit);
        assert!(
