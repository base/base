//! The asset-specific `IB20Asset` wire surface frozen at Cobalt, which added the ERC-8056
//! scheduled-multiplier surface. Also the canonical live surface, re-exported unqualified by
//! [`super`]. A new wire surface goes in a new `abi/vN.rs`; see [`super`].
