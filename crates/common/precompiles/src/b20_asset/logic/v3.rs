...
impl AssetV3 {
    ...
    ///
    /// Asset-specific (not part of [`B20TokenRole`]); kept inherent to V3 so it stays frozen with
...
impl<S: AssetAccounting, A: PolicyAccounting> Asset<S, A> for AssetV3 {
    fn transfer(
        &self,
        token: &mut B20AssetToken<S, A>,
        caller: Address,
...
mod tests {
    ...
    use crate::{
        Asset, AssetAccounting, AssetV3, B20_MAX_SUPPLY_CAP, B20AssetStorage, B20AssetToken,
        B20PolicyType, B20TokenRole, B20Variant, IB20, IB20Asset, PackedPolicy, PermitArgs,
    ...
    fn operator_role_matches_solidity_hash() {
        assert_eq!(AssetV3::OPERATOR_ROLE, keccak256("OPERATOR_ROLE"));
    }
    ...
    fn update_multiplier_requires_operator_role() {
        ...
        assert_eq!(
            ...
            BasePrecompileError::revert(IB20::AccessControlUnauthorizedAccount {
                account: ALICE,
                neededRole: AssetV3::OPERATOR_ROLE,
            })
        );
    }
    ...
    fn update_ui_multiplier_requires_operator_role() {
        ...
        grant(&mut tok, AssetV3::OPERATOR_ROLE, ALICE);
    ...
    fn supports_interface_advertises_claimed_ids_only() {
        ...
        for id in [
            ...
            assert!(
                <AssetV3 as Asset<FakeAccounting, FakePolicyAccounting>>::supports_interface(
                    &LOGIC,
                    FixedBytes::new(id)
                )
                .unwrap()
    ...
    fn max_ui_multiplier_getter_returns_uint128_max() {
        ...
        assert_eq!(AssetV3::MAX_UI_MULTIPLIER, U256::from(u128::MAX));
        let value =
            <AssetV3 as Asset<FakeAccounting, FakePolicyAccounting>>::max_ui_multiplier(&LOGIC)
                .unwrap();
