...
/// Second `PolicyRegistry` implementation. Frozen as of its activation at Cobalt.
...
impl PolicyRegistryV2 {
    ...
    /// under an empty native-precompile account. Kept inherent to V2 (off the trait) so it
