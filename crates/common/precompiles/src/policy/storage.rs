...
impl PolicyRegistryStorage<'_> {
    ...
    /// encoding is owned by the frozen [`crate::PolicyRegistryLogicV1`] logic and re-exported
    /// here for the registry's public API.
    pub const ALWAYS_ALLOW_ID: u64 = crate::PolicyRegistryLogicV1::ALWAYS_ALLOW_ID;

    /// Built-in policy ID that always rejects every account.
    ///
    /// A stable protocol sentinel; encoding owned by [`crate::PolicyRegistryLogicV1`].
    pub const ALWAYS_BLOCK_ID: u64 = crate::PolicyRegistryLogicV1::ALWAYS_BLOCK_ID;
}
...
mod tests {
    ...
    use crate::{
        ...
        PolicyContractContext, PolicyRegistryLogic, PolicyRegistryLogicV1,
