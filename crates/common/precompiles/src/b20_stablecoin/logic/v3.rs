//! Version 3 of the stablecoin B-20 precompile logic, activated at Denim.
...
use crate::{
    ...
    B20TokenRole, B20Variant, Eip712Domain, IB20, NonZeroAddress, PermitArgs, PolicyAccounting,
    Stablecoin, StablecoinAccounting, Token, TransferPolicyIds,
};
...
impl<S: StablecoinAccounting, A: PolicyAccounting> Stablecoin<S, A> for StablecoinV3 {
    fn transfer(
        &self,
        token: &mut B20StablecoinToken<S, A>,
        caller: Address,
...
mod tests {
    ...
    use crate::{
        B20_MAX_SUPPLY_CAP, B20PolicyType, B20StablecoinToken, B20TokenRole, B20Variant, IB20,
        PackedPolicy, PermitArgs, PolicyAccounting, PolicyRegistryStorage, PolicyVersion,
        Stablecoin, StablecoinAccounting, StablecoinV3, Token, TokenAccounting, TransferPolicyIds,
    };
