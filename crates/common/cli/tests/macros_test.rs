...
base_common_cli::define_metrics_args!("TEST", 9090);
...
mod custom_port {
    ...
    base_common_cli::define_metrics_args!("CUSTOM", 7300);
...
mod log_args_tests {
    use base_common_cli::{LogConfig, LogFormat};
    use clap::{CommandFactory, Parser};
    use tracing::level_filters::LevelFilter;

    base_common_cli::define_log_args!("TEST");
