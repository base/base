...
pub enum BaseTransactionError {
    ...
    ///
    /// In addition, this error is internal, and bubbles up into an [`BaseHaltReason::FailedDeposit`][crate::BaseHaltReason::FailedDeposit] error
    ...
    ///
    /// This is a catch-all error for any deposit transaction that results in an [`BaseHaltReason`][crate::BaseHaltReason] error
