...
use base_execution_state_types::{CanonStateNotification, Chain};
...
mod serde_bincode_compat {
    ...
    /// ```rust
    /// use crate::engine::{ExExNotificationBincode, ExExNotification};
    ...
    mod tests {
        ...
        use base_common_types_chain::{
            BaseBlock, BaseBlockBody, Header, RecoveredBlock, TxDeposit,
        };
        use base_execution_state_types::Chain;
        use serde::{Deserialize, Serialize};
        use serde_with::serde_as;

        use crate::engine::{ExExNotification, ExExNotificationBincode};
