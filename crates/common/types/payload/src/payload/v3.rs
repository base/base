...
use crate::{BlobsBundleV1, ExecutionPayloadEnvelopeV3, ExecutionPayloadV3};
...
pub struct BaseExecutionPayloadEnvelopeV3 {
...
mod tests {
    ...
    fn serde_roundtrip_execution_payload_envelope_v3() {
        ...
        let envelope: BaseExecutionPayloadEnvelopeV3 = serde_json::from_str(response).unwrap();
