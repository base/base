...
use base_common_types_chain::{
    BaseTxEnvelope, EIP1559ParamError, HoloceneExtraData, JovianExtraData, SealedBlock, WithEncoded,
};

/// Re-export for use in downstream arguments.
pub(crate) use crate::BasePayloadAttributes;
use crate::{
    ...
    PayloadAttributes as EthPayloadAttributes, PayloadId, builder::BuiltPayloadExecutedBlock,
};
...
impl BaseBuiltPayload {
    ...
    pub fn block_to_payload(block: SealedBlock, bal: Option<Bytes>) -> crate::ExecutionData {
        crate::ExecutionData::from_block_unchecked_with_extras(
            block.hash(),
            &block.into_block(),
            bal,
        )
...
impl From<BaseBuiltPayload> for crate::ExecutionData {
