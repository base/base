...
use crate::receipt::{
    Eip658Value, Eip2718DecodableReceipt, Eip2718EncodableReceipt, RlpDecodableReceipt,
...
pub(crate) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{serde_bincode_compat, Receipt};
    ...
    mod tests {
        ...
        use super::super::{Receipt, serde_bincode_compat};
