...
use crate::{BaseTxEnvelope, base_transaction::Eip8130Signed};
...
#[envelope(alloy_consensus = crate, tx_type_name = BasePooledTxType, serde_cfg(feature = "serde"), arbitrary_cfg(feature = "arbitrary"))]
...
impl From<BasePooledTransaction> for base_common_types_chain::transaction::PooledTransaction {
...
#[cfg(feature = "k256")]
impl base_common_types_chain::transaction::SignerRecoverable for BasePooledTransaction {
    fn recover_signer(
        &self,
        ...
        base_common_types_chain::crypto::secp256k1::recover_signer(self.signature(), signature_hash)
    }
