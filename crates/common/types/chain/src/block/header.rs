...
use alloy_eips::{
    BlockNumHash,
    eip1559::{
        BaseFeeParams, GAS_LIMIT_BOUND_DIVISOR, calc_next_block_base_fee,
...
pub(crate) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{serde_bincode_compat, Header};
    ...
    mod tests {
        ...
        use super::super::{Header, serde_bincode_compat};
...
mod tests {
    ...
    fn decode_header_rlp() {
        // ronin header
        let raw = hex!(
            ""
        );
