...
pub(super) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{BaseReceipt, serde_bincode_compat};
    ...
    pub enum BaseReceipt<'a> {
        /// Legacy receipt
        Legacy(base_common_types_chain::serde_bincode_compat::Receipt<'a, alloy_primitives::Log>),
        /// EIP-2930 receipt
        Eip2930(base_common_types_chain::serde_bincode_compat::Receipt<'a, alloy_primitives::Log>),
        /// EIP-1559 receipt
        Eip1559(base_common_types_chain::serde_bincode_compat::Receipt<'a, alloy_primitives::Log>),
        /// EIP-7702 receipt
        Eip7702(base_common_types_chain::serde_bincode_compat::Receipt<'a, alloy_primitives::Log>),
        /// Deposit receipt
