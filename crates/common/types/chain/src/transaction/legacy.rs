...
use alloy_rlp::{BufMut, Decodable, Encodable, Header, Result, length_of_length};
...
pub(super) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{serde_bincode_compat, TxLegacy};
    /// use serde::{Deserialize, Serialize};
    ...
    mod tests {
        ...
        use super::super::{TxLegacy, serde_bincode_compat};
...
mod tests {
    use alloy_primitives::{Address, B256, Signature, TxKind, U256, address, b256, hex};
