use alloy_eips::{Typed2718, eip2718::Eip2718Result};
...
pub(crate) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{serde_bincode_compat, EthereumTypedTransaction};
    ...
    mod tests {
        ...
        use super::super::{EthereumTypedTransaction, serde_bincode_compat};
        use crate::TxEip4844;
