...
use alloy_eips::{
    ...
    eip2718::IsTyped2718,
    eip2930::AccessList,
    eip7702::{SignedAuthorization, constants::EIP7702_TX_TYPE_ID},
};
...
pub(super) mod serde_bincode_compat {
    ...
    /// ```rust
    /// use base_common_types_chain::{serde_bincode_compat, TxEip7702};
    ...
    mod tests {
        ...
        use super::super::{TxEip7702, serde_bincode_compat};
...
mod tests {
    ...
    use alloy_primitives::{Address, Signature, U256, address, b256, hex};
