...
impl base_common_types_chain::alloy::transaction::ToTxCompact for BaseTxEnvelope {
...
impl base_common_types_chain::alloy::transaction::FromTxCompact for BaseTxEnvelope {
...
impl base_common_types_chain::alloy::transaction::Envelope for BaseTxEnvelope {
...
impl Compact for BaseTxEnvelope {
    ...
    where
        B: BufMut + AsMut<[u8]>,
    {
        base_common_types_chain::alloy::transaction::CompactEnvelope::to_compact(self, buf)
    }

    fn from_compact(buf: &[u8], len: usize) -> (Self, &[u8]) {
        base_common_types_chain::alloy::transaction::CompactEnvelope::from_compact(buf, len)
    }
}
...
#[reth_codecs(crate = "base_common_types_chain")]
#[reth_zstd(
    compressor = crate::StorageCodec::with_receipt_compressor,
    decompressor = crate::StorageCodec::with_receipt_decompressor
)]
...
impl base_common_types_chain::Decompress for BaseTxEnvelope {
...
impl base_common_types_chain::Compress for BaseReceipt {
    type Compressed = Vec<u8>;
...
impl base_common_types_chain::Decompress for BaseReceipt {
    fn decompress(value: &[u8]) -> Result<Self, DecompressError> {
        let (obj, _) = Compact::from_compact(value, value.len());
        Ok(obj)
    }
