...
mod test {
    ...
    use base_common_types_chain::{Eip658Value, EthereumReceipt, Receipt, ReceiptWithBloom};
    use rand_08::Rng;
    ...
    fn test_sanity() {
        ...
        const EXPECTED_BLOOM: Bloom = bloom!(
            ""
        );
    ...
    fn test_receipt_serde() {
        ...
        let receipt: EthereumReceipt<TxType, crate::Log> = serde_json::from_str(input).unwrap();
        let envelope: ReceiptEnvelope<crate::Log> = serde_json::from_str(input).unwrap();
