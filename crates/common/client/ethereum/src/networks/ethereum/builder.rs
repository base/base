...
mod tests {
    ...
    use base_common_types_rpc::{AccessList, TransactionRequest};
    ...
    fn test_tx_response_into_req() {
        ...
        let access_list_item = base_common_types_rpc::AccessListItem {
        ...
        let tx_response = base_common_types_rpc::Transaction {
