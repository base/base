...
use crate::{MulticallItem, Network, Provider, TransactionBuilder};
...
mod tests {
    ...
    use super::*;
    use crate::{CallItem, Failure, MulticallBuilder, Provider, ProviderBuilder};
    ...
    ) -> DummyThatFailsInstance<impl crate::Provider> {
