...
fn test_config(bucket: &str, tmp: &Path) -> base_infra_snapshotter::SnapshotterConfig {
    base_infra_snapshotter::SnapshotterConfig {
        ...
        tip_threshold_secs: base_infra_snapshotter::DEFAULT_TIP_THRESHOLD_SECS,
        ...
        s3_config_type: base_infra_snapshotter::S3ConfigType::Aws,
        s3_endpoint: None,
...
async fn orchestrator_always_restarts_on_failure() -> Result<()> {
    ...
    let snapshotter = base_infra_snapshotter::Snapshotter::new(
