...
impl LoadRunner {
    ...
    pub async fn run(&mut self) -> Result<MetricsSummary> {
        ...
        let (measurement_start_block, measurement_end_block, measurement_block_count) =
            results_tracker.measurement_window();
        summary.measurement_start_block = measurement_start_block;
        summary.measurement_end_block = measurement_end_block;
        summary.measurement_block_count = measurement_block_count;
