...
pub use commands::{
    ...
    ProofsProposeJson, ProofsProtocolArgs, ProofsStatusArgs, ProofsStatusJson, ProofsSubmitArgs,
    ProofsSubmitJson, SequencerAction, SequencerActionJson, SequencerCommand, SequencerCommands,
