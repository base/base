...
pub use rpc::{
    ...
    fetch_block_transactions, fetch_connected_peers, fetch_full_system_config,
    fetch_initial_backlog_with_progress, fetch_node_info, fetch_peer_stats, fetch_raw_info,
    fetch_raw_peers, fetch_safe_and_latest, fetch_sync_status, pause_sequencer_node,
