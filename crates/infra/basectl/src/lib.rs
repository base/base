...
pub use rpc::{
    ...
    RawPeersReport, SEQUENCER_ACTIVE_RPC_TIMEOUT, SyncStatusReport, TimestampedFlashblock,
    TxSummary, TxpoolClient, TxpoolCounts, TxpoolReport, TxpoolScope, TxpoolSenderSummary,
    TxpoolTransactionPool, TxpoolTransactionRow, ValidatorNodeStatus, add_peer, ban_peer,
