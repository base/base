...
use base_common_client_ethereum::{
    Base, Provider, ProviderBuilder,
    ext::{AdminApi, NetApi},
};
use base_common_client_rollup::BaseP2PApiClient;
use base_common_types_rpc::{ConsensusPeerInfo as PeerInfo, Direction, PeerStats};
...
fn parse_cl_node_endpoint(peer: &base_common_types_rpc::ConsensusPeerInfo) -> Result<NodeEndpoint> {
...
mod tests {
    ...
    use base_common_types_rpc::{
        Connectedness, ConsensusPeerInfo as PeerInfo, Direction, GossipScores, PeerScores,
        ReqRespScores,
    };
